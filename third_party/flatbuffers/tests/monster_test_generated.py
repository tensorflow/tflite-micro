...
class InParentNamespace(object):
  ...
  @classmethod
  def InParentNamespaceBufferHasIdentifier(cls,
                                           buf,
                                           offset,
                                           size_prefixed=False):
...
class TestSimpleTableWithEnum(object):
  ...
  @classmethod
  def TestSimpleTableWithEnumBufferHasIdentifier(cls,
                                                 buf,
                                                 offset,
                                                 size_prefixed=False):
    return flatbuffers.util.BufferHasIdentifier(buf,
...
class Vec3T(object):
  ...
  # Vec3T
  def Pack(self, builder):
    return CreateVec3(builder, self.x, self.y, self.z, self.test1, self.test2,
                      self.test3.a, self.test3.b)
...
def CreateStructOfStructs(builder, a_id, a_distance, b_a, b_b, c_id,
                          c_distance):
  builder.Prep(4, 20)
  builder.Prep(4, 8)
...
class StructOfStructsT(object):
  ...
  # StructOfStructsT
  def Pack(self, builder):
    return CreateStructOfStructs(builder, self.a.id, self.a.distance, self.b.a,
                                 self.b.b, self.c.id, self.c.distance)
...
def CreateStructOfStructsOfStructs(builder, a_a_id, a_a_distance, a_b_a, a_b_b,
                                   a_c_id, a_c_distance):
  builder.Prep(4, 20)
  builder.Prep(4, 20)
  builder.Prep(4, 8)
...
class StructOfStructsOfStructsT(object):
  ...
  def _UnPack(self, structOfStructsOfStructs):
    ...
    if structOfStructsOfStructs.A(StructOfStructs()) is not None:
      self.a = StructOfStructsT.InitFromObj(
          structOfStructsOfStructs.A(StructOfStructs()))

  # StructOfStructsOfStructsT
  def Pack(self, builder):
    return CreateStructOfStructsOfStructs(builder, self.a.a.id,
                                          self.a.a.distance, self.a.b.a,
                                          self.a.b.b, self.a.c.id,
                                          self.a.c.distance)
...
class Stat(object):
  ...
  def Count(self):
    ...
    if o != 0:
      return self._tab.Get(flatbuffers.number_types.Uint16Flags,
                           o + self._tab.Pos)
    return 0
...
class Referrable(object):
  ...
  def Id(self):
    o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(4))
    if o != 0:
      return self._tab.Get(flatbuffers.number_types.Uint64Flags,
                           o + self._tab.Pos)
    return 0
...
class Monster(object):
  ...
  def VectorOfDoublesAsNumpy(self):
    o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(70))
    if o != 0:
      return self._tab.GetVectorAsNumpy(flatbuffers.number_types.Float64Flags,
                                        o)
    return 0
  ...
  def VectorOfWeakReferencesAsNumpy(self):
    o = flatbuffers.number_types.UOffsetTFlags.py_type(self._tab.Offset(78))
    if o != 0:
      return self._tab.GetVectorAsNumpy(flatbuffers.number_types.Uint64Flags,
                                        o)
    return 0
...
def MonsterAddPos(builder, pos):
  builder.PrependStructSlot(
      0, flatbuffers.number_types.UOffsetTFlags.py_type(pos), 0)
...
def MonsterAddInventory(builder, inventory):
  builder.PrependUOffsetTRelativeSlot(
      5, flatbuffers.number_types.UOffsetTFlags.py_type(inventory), 0)
...
def MonsterAddTest(builder, test):
  builder.PrependUOffsetTRelativeSlot(
      8, flatbuffers.number_types.UOffsetTFlags.py_type(test), 0)


def MonsterAddTest4(builder, test4):
  builder.PrependUOffsetTRelativeSlot(
      9, flatbuffers.number_types.UOffsetTFlags.py_type(test4), 0)
...
def MonsterAddTestarrayofstring(builder, testarrayofstring):
  builder.PrependUOffsetTRelativeSlot(
      10, flatbuffers.number_types.UOffsetTFlags.py_type(testarrayofstring), 0)
...
def MonsterAddTestarrayoftables(builder, testarrayoftables):
  builder.PrependUOffsetTRelativeSlot(
      11, flatbuffers.number_types.UOffsetTFlags.py_type(testarrayoftables), 0)
...
def MonsterAddEnemy(builder, enemy):
  builder.PrependUOffsetTRelativeSlot(
      12, flatbuffers.number_types.UOffsetTFlags.py_type(enemy), 0)


def MonsterAddTestnestedflatbuffer(builder, testnestedflatbuffer):
  builder.PrependUOffsetTRelativeSlot(
      13, flatbuffers.number_types.UOffsetTFlags.py_type(testnestedflatbuffer),
      0)
...
def MonsterAddTestempty(builder, testempty):
  builder.PrependUOffsetTRelativeSlot(
      14, flatbuffers.number_types.UOffsetTFlags.py_type(testempty), 0)
...
def MonsterAddTestarrayofbools(builder, testarrayofbools):
  builder.PrependUOffsetTRelativeSlot(
      24, flatbuffers.number_types.UOffsetTFlags.py_type(testarrayofbools), 0)
...
def MonsterAddTestarrayofstring2(builder, testarrayofstring2):
  builder.PrependUOffsetTRelativeSlot(
      28, flatbuffers.number_types.UOffsetTFlags.py_type(testarrayofstring2),
      0)
...
def MonsterAddTestarrayofsortedstruct(builder, testarrayofsortedstruct):
  builder.PrependUOffsetTRelativeSlot(
      29,
      flatbuffers.number_types.UOffsetTFlags.py_type(testarrayofsortedstruct),
      0)
...
def MonsterAddFlex(builder, flex):
  builder.PrependUOffsetTRelativeSlot(
      30, flatbuffers.number_types.UOffsetTFlags.py_type(flex), 0)
...
def MonsterAddTest5(builder, test5):
  builder.PrependUOffsetTRelativeSlot(
      31, flatbuffers.number_types.UOffsetTFlags.py_type(test5), 0)
...
def MonsterAddVectorOfLongs(builder, vectorOfLongs):
  builder.PrependUOffsetTRelativeSlot(
      32, flatbuffers.number_types.UOffsetTFlags.py_type(vectorOfLongs), 0)
...
def MonsterAddVectorOfDoubles(builder, vectorOfDoubles):
  builder.PrependUOffsetTRelativeSlot(
      33, flatbuffers.number_types.UOffsetTFlags.py_type(vectorOfDoubles), 0)
...
def MonsterAddParentNamespaceTest(builder, parentNamespaceTest):
  builder.PrependUOffsetTRelativeSlot(
      34, flatbuffers.number_types.UOffsetTFlags.py_type(parentNamespaceTest),
      0)


def MonsterAddVectorOfReferrables(builder, vectorOfReferrables):
  builder.PrependUOffsetTRelativeSlot(
      35, flatbuffers.number_types.UOffsetTFlags.py_type(vectorOfReferrables),
      0)
...
def MonsterAddVectorOfWeakReferences(builder, vectorOfWeakReferences):
  builder.PrependUOffsetTRelativeSlot(
      37,
      flatbuffers.number_types.UOffsetTFlags.py_type(vectorOfWeakReferences),
      0)
...
def MonsterAddVectorOfNonOwningReferences(builder,
                                          vectorOfNonOwningReferences):
  builder.PrependUOffsetTRelativeSlot(
      42,
      flatbuffers.number_types.UOffsetTFlags.py_type(
          vectorOfNonOwningReferences), 0)
...
def MonsterAddAnyUnique(builder, anyUnique):
  builder.PrependUOffsetTRelativeSlot(
      44, flatbuffers.number_types.UOffsetTFlags.py_type(anyUnique), 0)
...
def MonsterAddAnyAmbiguous(builder, anyAmbiguous):
  builder.PrependUOffsetTRelativeSlot(
      46, flatbuffers.number_types.UOffsetTFlags.py_type(anyAmbiguous), 0)


def MonsterAddVectorOfEnums(builder, vectorOfEnums):
  builder.PrependUOffsetTRelativeSlot(
      47, flatbuffers.number_types.UOffsetTFlags.py_type(vectorOfEnums), 0)
...
def MonsterAddTestrequirednestedflatbuffer(builder,
...
def MonsterAddScalarKeySortedTables(builder, scalarKeySortedTables):
  builder.PrependUOffsetTRelativeSlot(
      50,
      flatbuffers.number_types.UOffsetTFlags.py_type(scalarKeySortedTables), 0)
...
def MonsterAddNativeInline(builder, nativeInline):
  builder.PrependStructSlot(
      51, flatbuffers.number_types.UOffsetTFlags.py_type(nativeInline), 0)
...
class MonsterT(object):
  ...
  def _UnPack(self, monster):
    ...
    if monster.ParentNamespaceTest() is not None:
      self.parentNamespaceTest = InParentNamespaceT.InitFromObj(
    ...
    if not monster.VectorOfStrongReferrablesIsNone():
      ...
      for i in range(monster.VectorOfStrongReferrablesLength()):
        if monster.VectorOfStrongReferrables(i) is None:
          ...
          referrable_ = ReferrableT.InitFromObj(
              monster.VectorOfStrongReferrables(i))
    ...
    if not monster.VectorOfCoOwningReferencesIsNone():
      if np is None:
        ...
        for i in range(monster.VectorOfCoOwningReferencesLength()):
          self.vectorOfCoOwningReferences.append(
              monster.VectorOfCoOwningReferences(i))
      else:
    ...
    if not monster.VectorOfNonOwningReferencesIsNone():
      if np is None:
        ...
        for i in range(monster.VectorOfNonOwningReferencesLength()):
          self.vectorOfNonOwningReferences.append(
              monster.VectorOfNonOwningReferences(i))
      else:
        self.vectorOfNonOwningReferences = monster.VectorOfNonOwningReferencesAsNumpy(
        )
    self.anyUniqueType = monster.AnyUniqueType()
    self.anyUnique = AnyUniqueAliasesCreator(self.anyUniqueType,
                                             monster.AnyUnique())
    self.anyAmbiguousType = monster.AnyAmbiguousType()
    self.anyAmbiguous = AnyAmbiguousAliasesCreator(self.anyAmbiguousType,
                                                   monster.AnyAmbiguous())
    ...
    if not monster.TestrequirednestedflatbufferIsNone():
      if np is None:
        ...
        for i in range(monster.TestrequirednestedflatbufferLength()):
          self.testrequirednestedflatbuffer.append(
              monster.Testrequirednestedflatbuffer(i))
      else:
  ...
  def Pack(self, builder):
    ...
    if self.testarrayofstring is not None:
      ...
      for i in range(len(self.testarrayofstring)):
        testarrayofstringlist.append(
            builder.CreateString(self.testarrayofstring[i]))
    ...
    if self.testnestedflatbuffer is not None:
      if np is not None and type(self.testnestedflatbuffer) is np.ndarray:
        testnestedflatbuffer = builder.CreateNumpyVector(
            self.testnestedflatbuffer)
      else:
        MonsterStartTestnestedflatbufferVector(builder,
                                               len(self.testnestedflatbuffer))
    ...
    if self.testarrayofstring2 is not None:
      ...
      for i in range(len(self.testarrayofstring2)):
        testarrayofstring2list.append(
            builder.CreateString(self.testarrayofstring2[i]))
      MonsterStartTestarrayofstring2Vector(builder,
                                           len(self.testarrayofstring2))
    ...
    if self.testarrayofsortedstruct is not None:
      MonsterStartTestarrayofsortedstructVector(
          builder, len(self.testarrayofsortedstruct))
    ...
    if self.vectorOfReferrables is not None:
      ...
      for i in range(len(self.vectorOfReferrables)):
        vectorOfReferrableslist.append(
            self.vectorOfReferrables[i].Pack(builder))
      MonsterStartVectorOfReferrablesVector(builder,
                                            len(self.vectorOfReferrables))
    ...
    if self.vectorOfWeakReferences is not None:
      if np is not None and type(self.vectorOfWeakReferences) is np.ndarray:
        vectorOfWeakReferences = builder.CreateNumpyVector(
            self.vectorOfWeakReferences)
      else:
        MonsterStartVectorOfWeakReferencesVector(
            builder, len(self.vectorOfWeakReferences))
    ...
    if self.vectorOfStrongReferrables is not None:
      ...
      for i in range(len(self.vectorOfStrongReferrables)):
        vectorOfStrongReferrableslist.append(
            self.vectorOfStrongReferrables[i].Pack(builder))
      MonsterStartVectorOfStrongReferrablesVector(
          builder, len(self.vectorOfStrongReferrables))
    ...
    if self.vectorOfCoOwningReferences is not None:
      if np is not None and type(
          self.vectorOfCoOwningReferences) is np.ndarray:
        vectorOfCoOwningReferences = builder.CreateNumpyVector(
            self.vectorOfCoOwningReferences)
      else:
    ...
    if self.vectorOfNonOwningReferences is not None:
      if np is not None and type(
          self.vectorOfNonOwningReferences) is np.ndarray:
        vectorOfNonOwningReferences = builder.CreateNumpyVector(
            self.vectorOfNonOwningReferences)
      else:
        MonsterStartVectorOfNonOwningReferencesVector(
            builder, len(self.vectorOfNonOwningReferences))
    ...
    if self.testrequirednestedflatbuffer is not None:
      if np is not None and type(
          self.testrequirednestedflatbuffer) is np.ndarray:
        testrequirednestedflatbuffer = builder.CreateNumpyVector(
            self.testrequirednestedflatbuffer)
      else:
        MonsterStartTestrequirednestedflatbufferVector(
    ...
    if self.scalarKeySortedTables is not None:
      ...
      for i in range(len(self.scalarKeySortedTables)):
        scalarKeySortedTableslist.append(
            self.scalarKeySortedTables[i].Pack(builder))
      MonsterStartScalarKeySortedTablesVector(builder,
                                              len(self.scalarKeySortedTables))
    ...
    if self.vectorOfNonOwningReferences is not None:
      MonsterAddVectorOfNonOwningReferences(builder,
                                            vectorOfNonOwningReferences)
    ...
    if self.testrequirednestedflatbuffer is not None:
      MonsterAddTestrequirednestedflatbuffer(builder,
                                             testrequirednestedflatbuffer)
    if self.scalarKeySortedTables is not None:
...
def TypeAliasesAddV8(builder, v8):
  builder.PrependUOffsetTRelativeSlot(
      10, flatbuffers.number_types.UOffsetTFlags.py_type(v8), 0)
...
def TypeAliasesAddVf64(builder, vf64):
  builder.PrependUOffsetTRelativeSlot(
      11, flatbuffers.number_types.UOffsetTFlags.py_type(vf64), 0)
