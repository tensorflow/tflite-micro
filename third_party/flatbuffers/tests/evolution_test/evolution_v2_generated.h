...
inline const Enum (&EnumValuesEnum())[4] {
  static const Enum values[] = { Enum::King, Enum::Queen, Enum::Rook,
                                 Enum::Bishop };
  return values;
}

inline const char *const *EnumNamesEnum() {
  static const char *const names[5] = { "King", "Queen", "Rook", "Bishop",
                                        nullptr };
  return names;
}
...
inline const Union (&EnumValuesUnion())[4] {
  static const Union values[] = { Union::NONE, Union::TableA, Union::TableB,
                                  Union::TableC };
  return values;
}

inline const char *const *EnumNamesUnion() {
  static const char *const names[5] = { "NONE", "TableA", "TableB", "TableC",
                                        nullptr };
  return names;
}
...
bool VerifyUnionVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<Union> *types);
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) Struct FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  Struct() : a_(0), padding0__(0), b_(0) { (void)padding0__; }
...
struct TableA FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  float a() const { return GetField<float>(VT_A, 0.0f); }
  int32_t b() const { return GetField<int32_t>(VT_B, 0); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_C) && verifier.VerifyString(c()) &&
           verifier.EndTable();
  }
};
...
struct TableABuilder {
  ...
  void add_a(float a) { fbb_.AddElement<float>(TableA::VT_A, a, 0.0f); }
  void add_b(int32_t b) { fbb_.AddElement<int32_t>(TableA::VT_B, b, 0); }
  void add_c(flatbuffers::Offset<flatbuffers::String> c) {
    fbb_.AddOffset(TableA::VT_C, c);
  }
  explicit TableABuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<TableA> CreateTableA(
    flatbuffers::FlatBufferBuilder &_fbb, float a = 0.0f, int32_t b = 0,
...
inline flatbuffers::Offset<TableA> CreateTableADirect(
  ...
  return Evolution::V2::CreateTableA(_fbb, a, b, c__);
}
...
struct TableB FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t a() const { return GetField<int32_t>(VT_A, 0); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_A, 4) && verifier.EndTable();
  }
};
...
struct TableBBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_a(int32_t a) { fbb_.AddElement<int32_t>(TableB::VT_A, a, 0); }
  explicit TableBBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<TableB> CreateTableB(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t a = 0) {
...
struct TableC FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  double a() const { return GetField<double>(VT_A, 0.0); }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_B) && verifier.VerifyString(b()) &&
           verifier.EndTable();
  }
};
...
struct TableCBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_a(double a) { fbb_.AddElement<double>(TableC::VT_A, a, 0.0); }
  void add_b(flatbuffers::Offset<flatbuffers::String> b) {
    fbb_.AddOffset(TableC::VT_B, b);
  }
  explicit TableCBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<TableC> CreateTableC(
    flatbuffers::FlatBufferBuilder &_fbb, double a = 0.0,
...
inline flatbuffers::Offset<TableC> CreateTableCDirect(
  ...
  return Evolution::V2::CreateTableC(_fbb, a, b__);
}
...
struct Root FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const void *c() const { return GetPointer<const void *>(VT_C); }
  template<typename T> const T *c_as() const;
  const Evolution::V2::TableA *c_as_TableA() const {
    return c_type() == Evolution::V2::Union::TableA
               ? static_cast<const Evolution::V2::TableA *>(c())
               : nullptr;
  }
  const Evolution::V2::TableB *c_as_TableB() const {
    return c_type() == Evolution::V2::Union::TableB
               ? static_cast<const Evolution::V2::TableB *>(c())
               : nullptr;
  }
  const Evolution::V2::TableC *c_as_TableC() const {
    return c_type() == Evolution::V2::Union::TableC
               ? static_cast<const Evolution::V2::TableC *>(c())
               : nullptr;
  }
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Evolution::V2::TableB>> *h()
      const {
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<Evolution::V2::TableB>> *>(VT_H);
  }
  uint32_t i() const { return GetField<uint32_t>(VT_I, 1234); }
  const Evolution::V2::TableC *k() const {
    return GetPointer<const Evolution::V2::TableC *>(VT_K);
  }
  uint8_t l() const { return GetField<uint8_t>(VT_L, 56); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_E) && verifier.VerifyTable(e()) &&
           VerifyField<Evolution::V2::Struct>(verifier, VT_FF, 8) &&
           VerifyOffset(verifier, VT_G) && verifier.VerifyVector(g()) &&
           VerifyOffset(verifier, VT_H) && verifier.VerifyVector(h()) &&
           verifier.VerifyVectorOfTables(h()) &&
           VerifyField<uint32_t>(verifier, VT_I, 4) &&
           VerifyOffset(verifier, VT_K) && verifier.VerifyTable(k()) &&
           VerifyField<uint8_t>(verifier, VT_L, 1) && verifier.EndTable();
  }
};

template<>
inline const Evolution::V2::TableA *Root::c_as<Evolution::V2::TableA>() const {
  return c_as_TableA();
}

template<>
inline const Evolution::V2::TableB *Root::c_as<Evolution::V2::TableB>() const {
  return c_as_TableB();
}

template<>
inline const Evolution::V2::TableC *Root::c_as<Evolution::V2::TableC>() const {
  return c_as_TableC();
}
...
struct RootBuilder {
  ...
  void add_c(flatbuffers::Offset<void> c) { fbb_.AddOffset(Root::VT_C, c); }
  ...
  void add_h(flatbuffers::Offset<
             flatbuffers::Vector<flatbuffers::Offset<Evolution::V2::TableB>>>
                 h) {
    fbb_.AddOffset(Root::VT_H, h);
  }
  void add_i(uint32_t i) { fbb_.AddElement<uint32_t>(Root::VT_I, i, 1234); }
  void add_k(flatbuffers::Offset<Evolution::V2::TableC> k) {
    fbb_.AddOffset(Root::VT_K, k);
  }
  void add_l(uint8_t l) { fbb_.AddElement<uint8_t>(Root::VT_L, l, 56); }
...
inline flatbuffers::Offset<Root> CreateRoot(
    flatbuffers::FlatBufferBuilder &_fbb, bool b = false,
    ...
    flatbuffers::Offset<
        flatbuffers::Vector<flatbuffers::Offset<Evolution::V2::TableB>>>
        h = 0,
    uint32_t i = 1234, flatbuffers::Offset<Evolution::V2::TableC> k = 0,
    uint8_t l = 56) {
...
inline flatbuffers::Offset<Root> CreateRootDirect(
  ...
  auto h__ =
      h ? _fbb.CreateVector<flatbuffers::Offset<Evolution::V2::TableB>>(*h) : 0;
  return Evolution::V2::CreateRoot(_fbb, b, c_type, c, d, e, ff, g__, h__, i, k,
                                   l);
}

inline bool VerifyUnion(flatbuffers::Verifier &verifier, const void *obj,
                        Union type) {
  switch (type) {
    case Union::NONE: {
      return true;
...
inline bool VerifyUnionVector(
  ...
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyUnion(verifier, values->Get(i), types->GetEnum<Union>(i))) {
      return false;
    }
  }
  return true;
...
inline void FinishRootBuffer(flatbuffers::FlatBufferBuilder &fbb,
