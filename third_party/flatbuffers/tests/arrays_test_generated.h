...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) NestedStruct FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  NestedStruct(flatbuffers::span<const int32_t, 2> _a,
    ...
    flatbuffers::CastToArrayOfEnum<MyGame::Example::TestEnum>(c_).CopyFromSpan(
        _c);
    (void)padding0__;
    (void)padding1__;
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) ArrayStruct FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  int32_t e() const { return flatbuffers::EndianScalar(e_); }
  void mutate_e(int32_t _e) { flatbuffers::WriteScalar(&e_, _e); }
...
struct ArrayTable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static flatbuffers::Offset<ArrayTable> Pack(
      flatbuffers::FlatBufferBuilder &_fbb, const ArrayTableT *_o,
...
inline void ArrayTable::UnPackTo(
    ArrayTableT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = a();
    if (_e)
      _o->a = flatbuffers::unique_ptr<MyGame::Example::ArrayStruct>(
...
inline const char *ArrayTableIdentifier() { return "ARRT"; }
...
inline const char *ArrayTableExtension() { return "mon"; }
...
inline flatbuffers::unique_ptr<MyGame::Example::ArrayTableT> UnPackArrayTable(
  ...
  return flatbuffers::unique_ptr<MyGame::Example::ArrayTableT>(
      GetArrayTable(buf)->UnPack(res));
}

inline flatbuffers::unique_ptr<MyGame::Example::ArrayTableT>
