...
public final class HandFan extends Table {
  ...
  public static HandFan getRootAsHandFan(ByteBuffer _bb) {
    return getRootAsHandFan(_bb, new HandFan());
  }
  ...
  public HandFan __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public boolean mutateLength(int length) {
    int o = __offset(4);
    if (o != 0) {
  ...
  public static int createHandFan(FlatBufferBuilder builder, int length) {
    builder.startTable(1);
    HandFan.addLength(builder, length);
    return HandFan.endHandFan(builder);
  }

  public static void startHandFan(FlatBufferBuilder builder) {
    builder.startTable(1);
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public HandFan get(int j) {
      return get(new HandFan(), j);
    }
    public HandFan get(HandFan obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, HandFanT _o) {
    if (_o == null)
      return 0;
    return createHandFan(builder, _o.getLength());
  }
}
