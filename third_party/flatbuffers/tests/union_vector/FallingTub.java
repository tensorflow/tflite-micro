...
public final class FallingTub extends Struct {
  ...
  public FallingTub __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public FallingTub get(int j) {
      return get(new FallingTub(), j);
    }
    public FallingTub get(FallingTub obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, FallingTubT _o) {
    if (_o == null)
      return 0;
    return createFallingTub(builder, _o.getWeight());
  }
}
