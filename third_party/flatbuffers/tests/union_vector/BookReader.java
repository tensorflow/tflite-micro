...
public final class BookReader extends Struct {
  ...
  public BookReader __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public void mutateBooksRead(int books_read) {
    bb.putInt(bb_pos + 0, books_read);
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public BookReader get(int j) {
      return get(new BookReader(), j);
    }
    public BookReader get(BookReader obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, BookReaderT _o) {
    if (_o == null)
      return 0;
    return createBookReader(builder, _o.getBooksRead());
  }
}
