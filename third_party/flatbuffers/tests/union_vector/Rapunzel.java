...
public final class Rapunzel extends Struct {
  ...
  public Rapunzel __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public void mutateHairLength(int hair_length) {
    bb.putInt(bb_pos + 0, hair_length);
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Rapunzel get(int j) {
      return get(new Rapunzel(), j);
    }
    public Rapunzel get(Rapunzel obj, int j) {
