...
public final class Attacker extends Table {
  ...
  public static Attacker getRootAsAttacker(ByteBuffer _bb) {
    return getRootAsAttacker(_bb, new Attacker());
  }
  ...
  public Attacker __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public boolean mutateSwordAttackDamage(int sword_attack_damage) {
    int o = __offset(4);
    if (o != 0) {
      bb.putInt(o + bb_pos, sword_attack_damage);
      return true;
    } else {
      return false;
    }
  ...
  public static int createAttacker(FlatBufferBuilder builder, int swordAttackDamage) {
    builder.startTable(1);
    Attacker.addSwordAttackDamage(builder, swordAttackDamage);
    return Attacker.endAttacker(builder);
  }

  public static void startAttacker(FlatBufferBuilder builder) {
    builder.startTable(1);
  }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Attacker get(int j) {
      return get(new Attacker(), j);
    }
    public Attacker get(Attacker obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, AttackerT _o) {
    if (_o == null)
      return 0;
    return createAttacker(builder, _o.getSwordAttackDamage());
  }
}
