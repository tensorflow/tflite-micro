...
inline const UnionInNestedNS (&EnumValuesUnionInNestedNS())[2] {
  static const UnionInNestedNS values[] = { UnionInNestedNS_NONE,
                                            UnionInNestedNS_TableInNestedNS };
  return values;
}

inline const char *const *EnumNamesUnionInNestedNS() {
  static const char *const names[3] = { "NONE", "TableInNestedNS", nullptr };
  return names;
}

inline const char *EnumNameUnionInNestedNS(UnionInNestedNS e) {
  if (flatbuffers::IsOutRange(e, UnionInNestedNS_NONE,
                              UnionInNestedNS_TableInNestedNS))
    return "";
...
template<>
struct UnionInNestedNSTraits<NamespaceA::NamespaceB::TableInNestedNS> {
...
template<>
struct UnionInNestedNSUnionTraits<NamespaceA::NamespaceB::TableInNestedNST> {
  static const UnionInNestedNS enum_value = UnionInNestedNS_TableInNestedNS;
};
...
struct UnionInNestedNSUnion {
  ...
  UnionInNestedNSUnion &operator=(const UnionInNestedNSUnion &u) {
    UnionInNestedNSUnion t(u);
    std::swap(type, t.type);
    std::swap(value, t.value);
    return *this;
  }
  UnionInNestedNSUnion &operator=(UnionInNestedNSUnion &&u)
  ...
  template<typename T> void Set(T &&val) {
    ...
    if (type != UnionInNestedNS_NONE) { value = new RT(std::forward<T>(val)); }
  }

  static void *UnPack(const void *obj, UnionInNestedNS type,
  ...
  NamespaceA::NamespaceB::TableInNestedNST *AsTableInNestedNS() {
    return type == UnionInNestedNS_TableInNestedNS
               ? reinterpret_cast<NamespaceA::NamespaceB::TableInNestedNST *>(
                     value)
               : nullptr;
  }
  const NamespaceA::NamespaceB::TableInNestedNST *AsTableInNestedNS() const {
    return type == UnionInNestedNS_TableInNestedNS
               ? reinterpret_cast<
                     const NamespaceA::NamespaceB::TableInNestedNST *>(value)
               : nullptr;
  }
};

inline bool operator==(const UnionInNestedNSUnion &lhs,
                       const UnionInNestedNSUnion &rhs) {
  ...
  switch (lhs.type) {
    ...
    case UnionInNestedNS_TableInNestedNS: {
      return *(reinterpret_cast<const NamespaceA::NamespaceB::TableInNestedNST
                                    *>(lhs.value)) ==
             *(reinterpret_cast<
                 const NamespaceA::NamespaceB::TableInNestedNST *>(rhs.value));
    }
    default: {
      return false;
    }
...
bool VerifyUnionInNestedNS(flatbuffers::Verifier &verifier, const void *obj,
                           UnionInNestedNS type);
bool VerifyUnionInNestedNSVector(
...
inline const EnumInNestedNS (&EnumValuesEnumInNestedNS())[3] {
  static const EnumInNestedNS values[] = { EnumInNestedNS_A, EnumInNestedNS_B,
                                           EnumInNestedNS_C };
  return values;
}
...
StructInNestedNS FLATBUFFERS_FINAL_CLASS {
 private:
  int32_t a_;
  int32_t b_;
...
inline bool operator==(const StructInNestedNS &lhs,
                       const StructInNestedNS &rhs) {
...
struct TableInNestedNS FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<int32_t>(verifier, VT_FOO, 4) && verifier.EndTable();
  }
  TableInNestedNST *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(
      TableInNestedNST *_o,
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  static flatbuffers::Offset<TableInNestedNS> Pack(
      flatbuffers::FlatBufferBuilder &_fbb, const TableInNestedNST *_o,
...
inline flatbuffers::Offset<TableInNestedNS> CreateTableInNestedNS(
    flatbuffers::FlatBufferBuilder &_fbb, int32_t foo = 0) {
  TableInNestedNSBuilder builder_(_fbb);
  builder_.add_foo(foo);
  return builder_.Finish();
}

flatbuffers::Offset<TableInNestedNS> CreateTableInNestedNS(
    flatbuffers::FlatBufferBuilder &_fbb, const TableInNestedNST *_o,
    const flatbuffers::rehasher_function_t *_rehasher = nullptr);

inline bool operator==(const TableInNestedNST &lhs,
                       const TableInNestedNST &rhs) {
...
inline TableInNestedNST *TableInNestedNS::UnPack(
...
inline void TableInNestedNS::UnPackTo(
    TableInNestedNST *_o,
    const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
...
inline flatbuffers::Offset<TableInNestedNS> TableInNestedNS::Pack(
    flatbuffers::FlatBufferBuilder &_fbb, const TableInNestedNST *_o,
...
inline flatbuffers::Offset<TableInNestedNS> CreateTableInNestedNS(
  ...
  struct _VectorArgs {
    ...
    const TableInNestedNST *__o;
    const flatbuffers::rehasher_function_t *__rehasher;
  } _va = { &_fbb, _o, _rehasher };
  (void)_va;
  auto _foo = _o->foo;
  return NamespaceA::NamespaceB::CreateTableInNestedNS(_fbb, _foo);
}

inline bool VerifyUnionInNestedNS(flatbuffers::Verifier &verifier,
                                  const void *obj, UnionInNestedNS type) {
  switch (type) {
    case UnionInNestedNS_NONE: {
      return true;
    }
    case UnionInNestedNS_TableInNestedNS: {
      auto ptr =
          reinterpret_cast<const NamespaceA::NamespaceB::TableInNestedNS *>(
              obj);
...
inline bool VerifyUnionInNestedNSVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<uint8_t> *types) {
  ...
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyUnionInNestedNS(verifier, values->Get(i),
                               types->GetEnum<UnionInNestedNS>(i))) {
      return false;
    }
  }
  return true;
...
inline void *UnionInNestedNSUnion::UnPack(
    const void *obj, UnionInNestedNS type,
    const flatbuffers::resolver_function_t *resolver) {
  (void)resolver;
  switch (type) {
...
inline flatbuffers::Offset<void> UnionInNestedNSUnion::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
  ...
  switch (type) {
    case UnionInNestedNS_TableInNestedNS: {
      auto ptr =
          reinterpret_cast<const NamespaceA::NamespaceB::TableInNestedNST *>(
              value);
...
inline UnionInNestedNSUnion::UnionInNestedNSUnion(const UnionInNestedNSUnion &u)
    : type(u.type), value(nullptr) {
  switch (type) {
    case UnionInNestedNS_TableInNestedNS: {
      value = new NamespaceA::NamespaceB::TableInNestedNST(
          *reinterpret_cast<NamespaceA::NamespaceB::TableInNestedNST *>(
              u.value));
      break;
    }
...
inline void UnionInNestedNSUnion::Reset() {
  switch (type) {
    case UnionInNestedNS_TableInNestedNS: {
      auto ptr =
          reinterpret_cast<NamespaceA::NamespaceB::TableInNestedNST *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline const flatbuffers::TypeTable *UnionInNestedNSTypeTable() {
  ...
  static const char *const names[] = { "NONE", "TableInNestedNS" };
