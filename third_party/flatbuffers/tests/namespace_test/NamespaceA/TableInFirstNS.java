...
public final class TableInFirstNS extends Table {
  ...
  public void unpackTo(TableInFirstNST _o) {
    if (fooTable() != null)
      _o.setFooTable(fooTable().unpack());
    else
      _o.setFooTable(null);
    ...
    switch (_oFooUnionType) {
      case NamespaceA.NamespaceB.UnionInNestedNS.TableInNestedNS:
        ...
        _oFooUnion.setValue(_oFooUnionValue != null
    ...
    if (fooStruct() != null)
      fooStruct().unpackTo(_o.getFooStruct());
    else
      _o.setFooStruct(null);
  }
  public static int pack(FlatBufferBuilder builder, TableInFirstNST _o) {
    if (_o == null)
      return 0;
    int _foo_table = _o.getFooTable() == null
        ? 0
        : NamespaceA.NamespaceB.TableInNestedNS.pack(builder, _o.getFooTable());
    byte _fooUnionType = _o.getFooUnion() == null ? NamespaceA.NamespaceB.UnionInNestedNS.NONE
                                                  : _o.getFooUnion().getType();
    int _fooUnion = _o.getFooUnion() == null
        ? 0
