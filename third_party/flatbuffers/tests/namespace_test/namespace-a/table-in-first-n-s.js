...
export class TableInFirstNS {
  ...
  fooStruct(obj) {
    ...
    return offset ?
        (obj || new StructInNestedNS()).__init(this.bb_pos + offset, this.bb) :
        null;
  }
  ...
  unpack() {
    return new TableInFirstNST(
        ...
        this.fooEnum(), this.fooUnionType(), (() => {
          let temp = unionToUnionInNestedNS(
              this.fooUnionType(), this.fooUnion.bind(this));
          if (temp === null) {
            return null;
          }
          return temp.unpack();
  ...
  unpackTo(_o) {
    ...
    _o.fooUnion = (() => {
      let temp =
          unionToUnionInNestedNS(this.fooUnionType(), this.fooUnion.bind(this));
      if (temp === null) {
        return null;
      }
      return temp.unpack();
...
export class TableInFirstNST {
  constructor(
      fooTable = null, fooEnum = EnumInNestedNS.A,
      fooUnionType = UnionInNestedNS.NONE, fooUnion = null, fooStruct = null) {
  ...
  pack(builder) {
    ...
    TableInFirstNS.addFooStruct(
        builder, (this.fooStruct !== null ? this.fooStruct.pack(builder) : 0));
