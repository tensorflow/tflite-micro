...
inline const OptionalByte (&EnumValuesOptionalByte())[3] {
  static const OptionalByte values[] = { OptionalByte_None, OptionalByte_One,
                                         OptionalByte_Two };
  return values;
}
...
inline const char *EnumNameOptionalByte(OptionalByte e) {
  if (flatbuffers::IsOutRange(e, OptionalByte_None, OptionalByte_Two))
    return "";
...
struct ScalarStuffT : public flatbuffers::NativeTable {
  ...
  optional_scalars::OptionalByte default_enum =
      optional_scalars::OptionalByte_One;
};
...
struct ScalarStuff FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_just_enum(optional_scalars::OptionalByte _just_enum =
                            static_cast<optional_scalars::OptionalByte>(0)) {
  ...
  bool mutate_default_enum(optional_scalars::OptionalByte _default_enum =
                               static_cast<optional_scalars::OptionalByte>(1)) {
...
inline bool operator==(const ScalarStuffT &lhs, const ScalarStuffT &rhs) {
  return (lhs.just_i8 == rhs.just_i8) && (lhs.maybe_i8 == rhs.maybe_i8) &&
         (lhs.default_i8 == rhs.default_i8) && (lhs.just_u8 == rhs.just_u8) &&
         (lhs.maybe_u8 == rhs.maybe_u8) && (lhs.default_u8 == rhs.default_u8) &&
         (lhs.just_i16 == rhs.just_i16) && (lhs.maybe_i16 == rhs.maybe_i16) &&
         (lhs.default_i16 == rhs.default_i16) &&
         (lhs.just_u16 == rhs.just_u16) && (lhs.maybe_u16 == rhs.maybe_u16) &&
         (lhs.default_u16 == rhs.default_u16) &&
         (lhs.just_i32 == rhs.just_i32) && (lhs.maybe_i32 == rhs.maybe_i32) &&
         (lhs.default_i32 == rhs.default_i32) &&
         (lhs.just_u32 == rhs.just_u32) && (lhs.maybe_u32 == rhs.maybe_u32) &&
         (lhs.default_u32 == rhs.default_u32) &&
         (lhs.just_i64 == rhs.just_i64) && (lhs.maybe_i64 == rhs.maybe_i64) &&
         (lhs.default_i64 == rhs.default_i64) &&
         (lhs.just_u64 == rhs.just_u64) && (lhs.maybe_u64 == rhs.maybe_u64) &&
         (lhs.default_u64 == rhs.default_u64) &&
         (lhs.just_f32 == rhs.just_f32) && (lhs.maybe_f32 == rhs.maybe_f32) &&
         (lhs.default_f32 == rhs.default_f32) &&
         (lhs.just_f64 == rhs.just_f64) && (lhs.maybe_f64 == rhs.maybe_f64) &&
...
inline const flatbuffers::TypeTable *ScalarStuffTypeTable() {
  ...
  static const char *const names[] = {
    "just_i8",     "maybe_i8",    "default_i8",   "just_u8",     "maybe_u8",
    "default_u8",  "just_i16",    "maybe_i16",    "default_i16", "just_u16",
    "maybe_u16",   "default_u16", "just_i32",     "maybe_i32",   "default_i32",
    "just_u32",    "maybe_u32",   "default_u32",  "just_i64",    "maybe_i64",
    "default_i64", "just_u64",    "maybe_u64",    "default_u64", "just_f32",
    "maybe_f32",   "default_f32", "just_f64",     "maybe_f64",   "default_f64",
    "just_bool",   "maybe_bool",  "default_bool", "just_enum",   "maybe_enum",
    "default_enum"
  };
  static const flatbuffers::TypeTable tt = {
...
inline optional_scalars::ScalarStuff *GetMutableSizePrefixedScalarStuff(
    void *buf) {
  return flatbuffers::GetMutableSizePrefixedRoot<optional_scalars::ScalarStuff>(
      buf);
}
...
inline bool SizePrefixedScalarStuffBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(buf, ScalarStuffIdentifier(), true);
}
...
inline flatbuffers::unique_ptr<optional_scalars::ScalarStuffT>
UnPackScalarStuff(const void *buf,
                  const flatbuffers::resolver_function_t *res = nullptr) {
  return flatbuffers::unique_ptr<optional_scalars::ScalarStuffT>(
