...
public final class Stat extends Table {
  ...
  public Stat __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public boolean mutateVal(long val) {
    int o = __offset(6);
    if (o != 0) {
      bb.putLong(o + bb_pos, val);
      return true;
    } else {
      return false;
    }
  ...
  public boolean mutateCount(int count) {
    int o = __offset(8);
    if (o != 0) {
      bb.putShort(o + bb_pos, (short) count);
      return true;
    } else {
      return false;
    }
  ...
  public static final class Vector extends BaseVector {
    ...
    public Stat get(int j) {
      return get(new Stat(), j);
    }
    public Stat get(Stat obj, int j) {
      return obj.__assign(__indirect(__element(j), bb), bb);
    }
    public Stat getByKey(int key) {
      return __lookup_by_key(null, __vector(), key, bb);
    }
    public Stat getByKey(Stat obj, int key) {
  ...
  public static int pack(FlatBufferBuilder builder, StatT _o) {
    ...
    return createStat(builder, _id, _o.getVal(), _o.getCount());
  }
}
