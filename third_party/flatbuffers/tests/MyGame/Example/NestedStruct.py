...
class NestedStruct(object):
  ...
  def A(self):
    return [
        self._tab.Get(
            ...
            flatbuffers.number_types.UOffsetTFlags.py_type(0 + i * 4))
        for i in range(2)
    ]
  ...
  def C(self):
    return [
        self._tab.Get(
            flatbuffers.number_types.Int8Flags, self._tab.Pos +
            flatbuffers.number_types.UOffsetTFlags.py_type(9 + i * 1))
        for i in range(2)
    ]
  ...
  def D(self):
    return [
        self._tab.Get(
            ...
            flatbuffers.number_types.UOffsetTFlags.py_type(16 + i * 8))
        for i in range(2)
    ]
