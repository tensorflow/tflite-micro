...
public final class Test extends Struct {
  ...
  public Test __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public void mutateA(short a) {
    bb.putShort(bb_pos + 0, a);
  }
  public byte b() {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Test get(int j) {
      return get(new Test(), j);
    }
    public Test get(Test obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, TestT _o) {
    if (_o == null)
      return 0;
    return createTest(builder, _o.getA(), _o.getB());
  }
}
