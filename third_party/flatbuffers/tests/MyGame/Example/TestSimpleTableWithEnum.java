...
final class TestSimpleTableWithEnum extends Table {
  ...
  public static TestSimpleTableWithEnum getRootAsTestSimpleTableWithEnum(
      ByteBuffer _bb, TestSimpleTableWithEnum obj) {
  ...
  public TestSimpleTableWithEnum __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public int color() {
    int o = __offset(4);
    return o != 0 ? bb.get(o + bb_pos) & 0xFF : 2;
  }
  ...
  public static int createTestSimpleTableWithEnum(FlatBufferBuilder builder, int color) {
  ...
  public static void addColor(FlatBufferBuilder builder, int color) {
    builder.addByte(0, (byte) color, (byte) 2);
  }
  ...
  static final class Vector extends BaseVector {
    ...
    public TestSimpleTableWithEnum get(int j) {
      return get(new TestSimpleTableWithEnum(), j);
    }
    public TestSimpleTableWithEnum get(TestSimpleTableWithEnum obj, int j) {
  ...
  public static int pack(FlatBufferBuilder builder, TestSimpleTableWithEnumT _o) {
    if (_o == null)
      return 0;
    return createTestSimpleTableWithEnum(builder, _o.getColor());
  }
}
