...
public final class Referrable extends Table {
  ...
  public static Referrable getRootAsReferrable(ByteBuffer _bb) {
    return getRootAsReferrable(_bb, new Referrable());
  }
  public static Referrable getRootAsReferrable(ByteBuffer _bb, Referrable obj) {
  ...
  public Referrable __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static int createReferrable(FlatBufferBuilder builder, long id) {
  ...
  public static Referrable __lookup_by_key(
      Referrable obj, int vectorLocation, long key, ByteBuffer bb) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Referrable get(int j) {
      return get(new Referrable(), j);
    }
    public Referrable get(Referrable obj, int j) {
      return obj.__assign(__indirect(__element(j), bb), bb);
    }
    public Referrable getByKey(long key) {
      return __lookup_by_key(null, __vector(), key, bb);
    }
    public Referrable getByKey(Referrable obj, long key) {
  ...
  public static int pack(FlatBufferBuilder builder, ReferrableT _o) {
    if (_o == null)
      return 0;
    return createReferrable(builder, _o.getId());
  }
}
