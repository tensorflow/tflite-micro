...
inline const Color (&EnumValuesColor())[3] {
  static const Color values[] = { Color::Red, Color::Green, Color::Blue };
  return values;
}
...
inline const Race (&EnumValuesRace())[4] {
  static const Race values[] = { Race::None, Race::Human, Race::Dwarf,
                                 Race::Elf };
  return values;
}
...
inline const LongEnum (&EnumValuesLongEnum())[3] {
  static const LongEnum values[] = { LongEnum::LongOne, LongEnum::LongTwo,
                                     LongEnum::LongBig };
  return values;
}
...
inline const Any (&EnumValuesAny())[4] {
  static const Any values[] = { Any::NONE, Any::Monster,
...
inline const char *EnumNameAny(Any e) {
  if (flatbuffers::IsOutRange(e, Any::NONE, Any::MyGame_Example2_Monster))
    return "";
...
struct AnyUnion {
  ...
  AnyUnion(AnyUnion &&u) FLATBUFFERS_NOEXCEPT : type(Any::NONE),
                                                value(nullptr) {
  ...
  template<typename T> void Set(T &&val) {
    ...
    if (type != Any::NONE) { value = new RT(std::forward<T>(val)); }
  }
...
bool VerifyAnyVector(
    ...
    const flatbuffers::Vector<Any> *types);
...
inline const AnyUniqueAliases (&EnumValuesAnyUniqueAliases())[4] {
  static const AnyUniqueAliases values[] = { AnyUniqueAliases::NONE,
                                             AnyUniqueAliases::M,
                                             AnyUniqueAliases::TS,
                                             AnyUniqueAliases::M2 };
  return values;
...
inline const char *EnumNameAnyUniqueAliases(AnyUniqueAliases e) {
  if (flatbuffers::IsOutRange(e, AnyUniqueAliases::NONE, AnyUniqueAliases::M2))
    return "";
  const size_t index = static_cast<size_t>(e);
...
bool VerifyAnyUniqueAliasesVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<AnyUniqueAliases> *types);
...
inline const AnyAmbiguousAliases (&EnumValuesAnyAmbiguousAliases())[4] {
  static const AnyAmbiguousAliases values[] = { AnyAmbiguousAliases::NONE,
...
inline const char *EnumNameAnyAmbiguousAliases(AnyAmbiguousAliases e) {
  if (flatbuffers::IsOutRange(e, AnyAmbiguousAliases::NONE,
                              AnyAmbiguousAliases::M3))
    return "";
  const size_t index = static_cast<size_t>(e);
...
bool VerifyAnyAmbiguousAliasesVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<AnyAmbiguousAliases> *types);
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(2) Test FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  template<size_t Index> auto get_field() const {
...
struct MonsterT : public flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<MyGame::Example::ReferrableT>>
  ...
  std::vector<std::unique_ptr<MyGame::Example::StatT>>
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const MyGame::Example::Monster *test_as_Monster() const {
    return test_type() == MyGame::Example::Any::Monster
  ...
  test_as_TestSimpleTableWithEnum() const {
    return test_type() == MyGame::Example::Any::TestSimpleTableWithEnum
  ...
  const MyGame::Example2::Monster *test_as_MyGame_Example2_Monster() const {
    return test_type() == MyGame::Example::Any::MyGame_Example2_Monster
  ...
  const MyGame::Example::Monster *any_unique_as_M() const {
    return any_unique_type() == MyGame::Example::AnyUniqueAliases::M
               ? static_cast<const MyGame::Example::Monster *>(any_unique())
               : nullptr;
  }
  const MyGame::Example::TestSimpleTableWithEnum *any_unique_as_TS() const {
    return any_unique_type() == MyGame::Example::AnyUniqueAliases::TS
               ? static_cast<const MyGame::Example::TestSimpleTableWithEnum *>(
                     any_unique())
               : nullptr;
  }
  const MyGame::Example2::Monster *any_unique_as_M2() const {
    return any_unique_type() == MyGame::Example::AnyUniqueAliases::M2
  ...
  const MyGame::Example::Monster *any_ambiguous_as_M1() const {
    return any_ambiguous_type() == MyGame::Example::AnyAmbiguousAliases::M1
               ? static_cast<const MyGame::Example::Monster *>(any_ambiguous())
               : nullptr;
  }
  const MyGame::Example::Monster *any_ambiguous_as_M2() const {
    return any_ambiguous_type() == MyGame::Example::AnyAmbiguousAliases::M2
               ? static_cast<const MyGame::Example::Monster *>(any_ambiguous())
               : nullptr;
  }
  const MyGame::Example::Monster *any_ambiguous_as_M3() const {
    return any_ambiguous_type() == MyGame::Example::AnyAmbiguousAliases::M3
               ? static_cast<const MyGame::Example::Monster *>(any_ambiguous())
               : nullptr;
  }
  ...
  const flatbuffers::Vector<MyGame::Example::Color> *vector_of_enums() const {
    return GetPointer<const flatbuffers::Vector<MyGame::Example::Color> *>(
        VT_VECTOR_OF_ENUMS);
  }
  flatbuffers::Vector<MyGame::Example::Color> *mutable_vector_of_enums() {
    return GetPointer<flatbuffers::Vector<MyGame::Example::Color> *>(
        VT_VECTOR_OF_ENUMS);
  }
  ...
  template<size_t Index> auto get_field() const {
    if constexpr (Index == 0)
      ...
      return testhashs32_fnv1();
    else if constexpr (Index == 16)
      return testhashu32_fnv1();
    else if constexpr (Index == 17)
      return testhashs64_fnv1();
    else if constexpr (Index == 18)
      return testhashu64_fnv1();
    else if constexpr (Index == 19)
      return testhashs32_fnv1a();
    else if constexpr (Index == 20)
      return testhashu32_fnv1a();
    else if constexpr (Index == 21)
      return testhashs64_fnv1a();
    else if constexpr (Index == 22)
      return testhashu64_fnv1a();
...
struct MonsterBuilder {
  ...
  void add_vector_of_enums(
      flatbuffers::Offset<flatbuffers::Vector<MyGame::Example::Color>>
          vector_of_enums) {
...
inline flatbuffers::Offset<Monster> CreateMonster(
    ...
    MyGame::Example::AnyUniqueAliases any_unique_type =
        MyGame::Example::AnyUniqueAliases::NONE,
    flatbuffers::Offset<void> any_unique = 0,
    MyGame::Example::AnyAmbiguousAliases any_ambiguous_type =
        MyGame::Example::AnyAmbiguousAliases::NONE,
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
  ...
  auto vector_of_enums__ =
      vector_of_enums
          ? _fbb.CreateVector<MyGame::Example::Color>(*vector_of_enums)
          : 0;
...
inline void Monster::UnPackTo(
  ...
  (void)_resolver;
  {
    auto _e = pos();
    if (_e)
      _o->pos = std::unique_ptr<MyGame::Example::Vec3>(
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->testarrayoftables[_i]) {
          ...
          _o->testarrayoftables[_i] =
              std::unique_ptr<MyGame::Example::MonsterT>(
  ...
  }
  {
    ...
    if (_e) {
      if (_o->enemy) {
        ...
        _o->enemy =
            std::unique_ptr<MyGame::Example::MonsterT>(_e->UnPack(_resolver));
      }
    }
  }
  {
  ...
  }
  {
    ...
    if (_e) {
      if (_o->testempty) {
        ...
        _o->testempty =
            std::unique_ptr<MyGame::Example::StatT>(_e->UnPack(_resolver));
      }
    }
  }
  {
    ...
    if (_e) {
      if (_o->parent_namespace_test) {
        ...
        _o->parent_namespace_test =
            std::unique_ptr<MyGame::InParentNamespaceT>(_e->UnPack(_resolver));
      }
    }
  }
  {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->vector_of_referrables[_i]) {
          ...
          _o->vector_of_referrables[_i] =
              std::unique_ptr<MyGame::Example::ReferrableT>(
                  _e->Get(_i)->UnPack(_resolver));
        };
      }
    }
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->scalar_key_sorted_tables[_i]) {
          ...
          _o->scalar_key_sorted_tables[_i] =
              std::unique_ptr<MyGame::Example::StatT>(
                  _e->Get(_i)->UnPack(_resolver));
        };
      }
    }
...
inline flatbuffers::Offset<Monster> CreateMonster(
  ...
  auto _vector_of_enums =
      _o->vector_of_enums.size() ? _fbb.CreateVector(_o->vector_of_enums) : 0;
...
inline std::unique_ptr<MyGame::Example::MonsterT> UnPackMonster(
  ...
  return std::unique_ptr<MyGame::Example::MonsterT>(
