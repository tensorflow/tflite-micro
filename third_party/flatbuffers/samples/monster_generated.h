...
inline const char *const *EnumNamesColor() {
  static const char *const names[4] = { "Red", "Green", "Blue", nullptr };
  return names;
}
...
inline const Equipment (&EnumValuesEquipment())[2] {
  static const Equipment values[] = { Equipment_NONE, Equipment_Weapon };
  return values;
}

inline const char *const *EnumNamesEquipment() {
  static const char *const names[3] = { "NONE", "Weapon", nullptr };
  return names;
}
...
struct EquipmentUnion {
  ...
  template<typename T> void Set(T &&val) {
    ...
    if (type != Equipment_NONE) { value = new RT(std::forward<T>(val)); }
  }

  static void *UnPack(const void *obj, Equipment type,
  ...
  MyGame::Sample::WeaponT *AsWeapon() {
    return type == Equipment_Weapon
               ? reinterpret_cast<MyGame::Sample::WeaponT *>(value)
               : nullptr;
  }
  const MyGame::Sample::WeaponT *AsWeapon() const {
    return type == Equipment_Weapon
               ? reinterpret_cast<const MyGame::Sample::WeaponT *>(value)
               : nullptr;
  }
};
...
bool VerifyEquipment(flatbuffers::Verifier &verifier, const void *obj,
                     Equipment type);
bool VerifyEquipmentVector(
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_color(
      MyGame::Sample::Color _color = static_cast<MyGame::Sample::Color>(2)) {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Weapon>>
    ...
    return GetPointer<const flatbuffers::Vector<
        flatbuffers::Offset<MyGame::Sample::Weapon>> *>(VT_WEAPONS);
  }
  flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Weapon>>
      *mutable_weapons() {
    return GetPointer<
        flatbuffers::Vector<flatbuffers::Offset<MyGame::Sample::Weapon>> *>(
        VT_WEAPONS);
  ...
  MyGame::Sample::Equipment equipped_type() const {
    return static_cast<MyGame::Sample::Equipment>(
        GetField<uint8_t>(VT_EQUIPPED_TYPE, 0));
  }
  ...
  const MyGame::Sample::Weapon *equipped_as_Weapon() const {
    return equipped_type() == MyGame::Sample::Equipment_Weapon
               ? static_cast<const MyGame::Sample::Weapon *>(equipped())
               : nullptr;
  }
  void *mutable_equipped() { return GetPointer<void *>(VT_EQUIPPED); }
  const flatbuffers::Vector<const MyGame::Sample::Vec3 *> *path() const {
    return GetPointer<
        const flatbuffers::Vector<const MyGame::Sample::Vec3 *> *>(VT_PATH);
  }
  flatbuffers::Vector<const MyGame::Sample::Vec3 *> *mutable_path() {
    return GetPointer<flatbuffers::Vector<const MyGame::Sample::Vec3 *> *>(
        VT_PATH);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_PATH) && verifier.VerifyVector(path()) &&
           verifier.EndTable();
  }
  MonsterT *UnPack(
...
template<>
inline const MyGame::Sample::Weapon *
Monster::equipped_as<MyGame::Sample::Weapon>() const {
...
struct MonsterBuilder {
  ...
  void add_equipped_type(MyGame::Sample::Equipment equipped_type) {
    fbb_.AddElement<uint8_t>(Monster::VT_EQUIPPED_TYPE,
                             static_cast<uint8_t>(equipped_type), 0);
  }
...
inline flatbuffers::Offset<Monster> CreateMonster(
    flatbuffers::FlatBufferBuilder &_fbb,
    const MyGame::Sample::Vec3 *pos = nullptr, int16_t mana = 150,
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    ...
    MyGame::Sample::Color color = MyGame::Sample::Color_Blue,
    const std::vector<flatbuffers::Offset<MyGame::Sample::Weapon>> *weapons =
        nullptr,
    MyGame::Sample::Equipment equipped_type = MyGame::Sample::Equipment_NONE,
    flatbuffers::Offset<void> equipped = 0,
  ...
  auto weapons__ =
      weapons ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Weapon>>(
                    *weapons)
              : 0;
  auto path__ =
      path ? _fbb.CreateVectorOfStructs<MyGame::Sample::Vec3>(*path) : 0;
  return MyGame::Sample::CreateMonster(_fbb, pos, mana, hp, name__, inventory__,
                                       color, weapons__, equipped_type,
                                       equipped, path__);
}
...
struct Weapon FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_NAME) &&
           ...
           VerifyField<int16_t>(verifier, VT_DAMAGE, 2) && verifier.EndTable();
  }
  WeaponT *UnPack(
      const flatbuffers::resolver_function_t *_resolver = nullptr) const;
  void UnPackTo(WeaponT *_o, const flatbuffers::resolver_function_t *_resolver =
                                 nullptr) const;
  static flatbuffers::Offset<Weapon> Pack(
      flatbuffers::FlatBufferBuilder &_fbb, const WeaponT *_o,
      const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct WeaponBuilder {
  ...
  explicit WeaponBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Weapon> CreateWeapon(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::String> name = 0, int16_t damage = 0) {
...
inline flatbuffers::Offset<Weapon> CreateWeaponDirect(
    ...
    int16_t damage = 0) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return MyGame::Sample::CreateWeapon(_fbb, name__, damage);
}
...
inline bool operator==(const MonsterT &lhs, const MonsterT &rhs) {
  return ((lhs.pos == rhs.pos) ||
         ...
         (lhs.color == rhs.color) &&
         (lhs.weapons.size() == rhs.weapons.size() &&
          std::equal(
              lhs.weapons.cbegin(), lhs.weapons.cend(), rhs.weapons.cbegin(),
              [](flatbuffers::unique_ptr<MyGame::Sample::WeaponT> const &a,
                 flatbuffers::unique_ptr<MyGame::Sample::WeaponT> const &b) {
                return (a == b) || (a && b && *a == *b);
              })) &&
         (lhs.equipped == rhs.equipped) && (lhs.path == rhs.path);
}
...
inline MonsterT::MonsterT(const MonsterT &o)
  ...
  for (const auto &weapons_ : o.weapons) {
    weapons.emplace_back((weapons_) ? new MyGame::Sample::WeaponT(*weapons_)
                                    : nullptr);
  }
}
...
inline void Monster::UnPackTo(
  ...
  (void)_resolver;
  {
    auto _e = pos();
    if (_e)
      _o->pos = flatbuffers::unique_ptr<MyGame::Sample::Vec3>(
          new MyGame::Sample::Vec3(*_e));
  }
  {
    auto _e = mana();
    _o->mana = _e;
  ...
  }
  {
    auto _e = weapons();
    if (_e) {
      _o->weapons.resize(_e->size());
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->weapons[_i]) {
          _e->Get(_i)->UnPackTo(_o->weapons[_i].get(), _resolver);
        } else {
          _o->weapons[_i] = flatbuffers::unique_ptr<MyGame::Sample::WeaponT>(
  ...
  {
    auto _e = equipped_type();
    _o->equipped.type = _e;
  }
  {
    auto _e = equipped();
    if (_e)
      _o->equipped.value = MyGame::Sample::EquipmentUnion::UnPack(
          _e, equipped_type(), _resolver);
  }
  {
    auto _e = path();
    if (_e) {
      _o->path.resize(_e->size());
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->path[_i] = *_e->Get(_i);
      }
    }
  }
}
...
inline flatbuffers::Offset<Monster> CreateMonster(
  ...
  auto _weapons =
      _o->weapons.size()
          ? _fbb.CreateVector<flatbuffers::Offset<MyGame::Sample::Weapon>>(
                _o->weapons.size(),
                [](size_t i, _VectorArgs *__va) {
                  return CreateWeapon(*__va->__fbb, __va->__o->weapons[i].get(),
                                      __va->__rehasher);
                },
                &_va)
          : 0;
  ...
  return MyGame::Sample::CreateMonster(_fbb, _pos, _mana, _hp, _name,
                                       _inventory, _color, _weapons,
                                       _equipped_type, _equipped, _path);
}
...
inline void Weapon::UnPackTo(
    WeaponT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = name();
...
inline flatbuffers::Offset<Weapon> Weapon::Pack(
    flatbuffers::FlatBufferBuilder &_fbb, const WeaponT *_o,
    const flatbuffers::rehasher_function_t *_rehasher) {
...
inline flatbuffers::Offset<Weapon> CreateWeapon(
  ...
  return MyGame::Sample::CreateWeapon(_fbb, _name, _damage);
}

inline bool VerifyEquipment(flatbuffers::Verifier &verifier, const void *obj,
                            Equipment type) {
  switch (type) {
    case Equipment_NONE: {
      return true;
...
inline bool VerifyEquipmentVector(
    flatbuffers::Verifier &verifier,
    const flatbuffers::Vector<flatbuffers::Offset<void>> *values,
    const flatbuffers::Vector<uint8_t> *types) {
  ...
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyEquipment(verifier, values->Get(i),
                         types->GetEnum<Equipment>(i))) {
      return false;
    }
  }
  return true;
...
inline void *EquipmentUnion::UnPack(
    const void *obj, Equipment type,
    const flatbuffers::resolver_function_t *resolver) {
  (void)resolver;
  switch (type) {
    case Equipment_Weapon: {
...
inline flatbuffers::Offset<void> EquipmentUnion::Pack(
    flatbuffers::FlatBufferBuilder &_fbb,
...
inline EquipmentUnion::EquipmentUnion(const EquipmentUnion &u)
    : type(u.type), value(nullptr) {
  switch (type) {
    case Equipment_Weapon: {
      value = new MyGame::Sample::WeaponT(
          *reinterpret_cast<MyGame::Sample::WeaponT *>(u.value));
      break;
    }
    default: break;
  }
...
inline const flatbuffers::TypeTable *EquipmentTypeTable() {
  ...
  static const char *const names[] = { "NONE", "Weapon" };
  static const flatbuffers::TypeTable tt = {
...
inline const flatbuffers::TypeTable *MonsterTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
    ...
    { flatbuffers::ET_CHAR, 0, 1 },     { flatbuffers::ET_SEQUENCE, 1, 2 },
    { flatbuffers::ET_UTYPE, 0, 3 },    { flatbuffers::ET_SEQUENCE, 0, 3 },
    { flatbuffers::ET_SEQUENCE, 1, 0 }
  };
  static const flatbuffers::TypeFunction type_refs[] = {
    MyGame::Sample::Vec3TypeTable, MyGame::Sample::ColorTypeTable,
    MyGame::Sample::WeaponTypeTable, MyGame::Sample::EquipmentTypeTable
  };
  static const char *const names[] = { "pos",      "mana",     "hp",
                                       "name",     "friendly", "inventory",
                                       "color",    "weapons",  "equipped_type",
                                       "equipped", "path" };
  static const flatbuffers::TypeTable tt = {
...
inline const flatbuffers::TypeTable *WeaponTypeTable() {
  static const flatbuffers::TypeCode type_codes[] = {
    { flatbuffers::ET_STRING, 0, -1 }, { flatbuffers::ET_SHORT, 0, -1 }
  };
  static const char *const names[] = { "name", "damage" };
  static const flatbuffers::TypeTable tt = {
...
inline flatbuffers::unique_ptr<MyGame::Sample::MonsterT> UnPackMonster(
  ...
  return flatbuffers::unique_ptr<MyGame::Sample::MonsterT>(
      GetMonster(buf)->UnPack(res));
}

inline flatbuffers::unique_ptr<MyGame::Sample::MonsterT>
