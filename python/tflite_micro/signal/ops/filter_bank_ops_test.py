...
class FilterBankOpTest(tf.test.TestCase):
  ...
  def testFilterBankCenterFreq(self):
    ...
    center_freq_exp = [
      249.2831420898437500,
      313.3967285156250000,
      377.5103454589843750,
      441.6239624023437500,
      505.7375488281250000,
      569.8511352539062500,
      633.9647827148437500,
      698.0783691406250000,
      762.1919555664062500,
      826.3055419921875000,
      890.4191894531250000,
      954.5327758789062500,
      1018.6463623046875000,
      1082.7600097656250000,
      1146.8735351562500000,
      1210.9871826171875000,
      1275.1008300781250000,
      1339.2143554687500000,
      1403.3280029296875000,
      1467.4415283203125000,
      1531.5551757812500000,
      1595.6688232421875000,
      1659.7823486328125000,
      1723.8959960937500000,
      1788.0096435546875000,
      1852.1231689453125000,
      1916.2368164062500000,
      1980.3504638671875000,
      2044.4639892578125000,
      2108.5776367187500000,
      2172.6911621093750000,
      2236.8046875000000000,
      2300.9182128906250000,
      2365.0319824218750000,
      2429.1455078125000000,
      2493.2590332031250000,
      2557.3728027343750000,
      2621.4863281250000000,
      2685.5998535156250000,
      2749.7133789062500000,
      2813.8271484375000000,
    ]
    self.assertAllEqual(center_freq_exp, center_freq)

    center_freq = filter_bank_ops._calc_center_freq(33, 125, 3800)
    center_freq_exp = [
      243.1058502197265625,
      301.0421752929687500,
      358.9784851074218750,
      416.9147949218750000,
      474.8511352539062500,
      532.7874145507812500,
      590.7237548828125000,
      648.6600341796875000,
      706.5963745117187500,
      764.5327148437500000,
      822.4689941406250000,
      880.4053344726562500,
      938.3416137695312500,
      996.2779541015625000,
      1054.2142333984375000,
      1112.1505126953125000,
      1170.0869140625000000,
      1228.0231933593750000,
      1285.9594726562500000,
      1343.8958740234375000,
      1401.8321533203125000,
      1459.7684326171875000,
      1517.7047119140625000,
      1575.6411132812500000,
      1633.5773925781250000,
      1691.5136718750000000,
      1749.4500732421875000,
      1807.3863525390625000,
      1865.3226318359375000,
      1923.2589111328125000,
      1981.1953125000000000,
      2039.1315917968750000,
      2097.0678710937500000,
    ]
    self.assertAllEqual(center_freq_exp, center_freq)

    center_freq = filter_bank_ops._calc_center_freq(41, 100, 7500)
    center_freq_exp = [
      214.4616394042968750,
      278.4334106445312500,
      342.4051513671875000,
      406.3768920898437500,
      470.3486328125000000,
      534.3204345703125000,
      598.2921752929687500,
      662.2639160156250000,
      726.2356567382812500,
      790.2073974609375000,
      854.1791992187500000,
      918.1509399414062500,
      982.1226806640625000,
      1046.0944824218750000,
      1110.0662841796875000,
      1174.0379638671875000,
      1238.0097656250000000,
      1301.9814453125000000,
      1365.9532470703125000,
      1429.9249267578125000,
      1493.8967285156250000,
      1557.8685302734375000,
      1621.8402099609375000,
      1685.8120117187500000,
      1749.7838134765625000,
      1813.7554931640625000,
      1877.7272949218750000,
      1941.6990966796875000,
      2005.6707763671875000,
      2069.6425781250000000,
      2133.6142578125000000,
      2197.5861816406250000,
      2261.5578613281250000,
      2325.5297851562500000,
      2389.5014648437500000,
      2453.4731445312500000,
      2517.4450683593750000,
      2581.4167480468750000,
      2645.3884277343750000,
      2709.3601074218750000,
      2773.3320312500000000,
    ]
  ...
  def testFilterBankInitWeight(self):
    (
      ...
      channel_widths,
    ) = filter_bank_ops._init_filter_bank_weights(
  ...
  def SingleFilterBankSpectralSubtractionVectorTest(self, filename):
    ...
    concrete_function = func.get_concrete_function(
      tf.TensorSpec(input_size, dtype=tf.uint32),
      num_channels,
      smoothing,
      alternate_smoothing,
      smoothing_bits,
  ...
  def SingleFilterBankTest(self, filename):
    ...
    output_tensor = self.evaluate(
      filter_bank_ops.filter_bank(
        input_tensor, int(args[1]), int(args[4]), float(args[2]), float(args[3])
      )
    )
  ...
  def testFilterBankLog(self):
    ...
    output_array = self.evaluate(
      filter_bank_ops.filter_bank_log(
        input_array, output_scale, correction_bits
      )
    )
    self.assertAllEqual(output_array, output_exp)
