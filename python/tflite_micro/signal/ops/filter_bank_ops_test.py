...
class FilterBankOpTest(tf.test.TestCase):
  ...
  def testFilterBankInitWeight(self):
    (start_index, end_index, weights, unweights,
     channel_frequency_starts, channel_weight_starts,
    ...
    weights_exp = [
        ...
        2920, 2013, 1117, 231, 3450, 2583, 1725, 877, 37, 3302, 2480, 1666, 861,
        63, 3369, 2588, 1813, 1046, 287, 3630, 2885, 2147, 1415, 690, 4067,
        3355, 2650, 1950, 1257, 569, 3984, 3308, 2638, 1973, 1314, 661, 12,
        3465, 2827, 2194, 1566, 944, 325, 3808, 3199, 2595, 1996, 1401, 810,
        224, 3738, 3160, 2586, 2017, 1451, 890, 332
    ]
    unweights_exp = [
        ...
        28, 740, 1445, 2145, 2838, 3526, 111, 787, 1457, 2122, 2781, 3434, 4083,
        630, 1268, 1901, 2529, 3151, 3770, 287, 896, 1500, 2099, 2694, 3285,
        3871, 357, 935, 1509, 2078, 2644, 3205, 3763,
    ]
    ...
    channel_weight_starts_exp = [
        0, 1, 2, 4, 6, 7, 9, 11, 13, 15, 17, 20, 22, 25, 27, 30, 33, 36, 40, 43,
        47, 51, 55, 59, 64, 69, 74, 79, 84, 90, 97, 103, 110]
    channel_widths_exp = [
    ...
    ##################################
    (start_index, end_index, weights,
     unweights, channel_frequency_starts, channel_weight_starts,
     channel_widths) = filter_bank_ops._init_filter_bank_weights(
    ...
    unweights_exp = [
        2676, 1161, 3653, 1965, 199, 2457, 549, 2673, 641, 2646, 502, 2402, 157,
        1961, 3722, 1344, 3022, 567, 2170, 3739, 1178, 2681, 58, 1501, 2915,
        207, 1568, 2904, 119, 1407, 2673, 3916, 1043, 2245, 3427, 494, 1639,
        2766, 3875, 872, 1948, 3008, 4053, 987, 2003, 3004, 3992, 870, 1832,
        2780, 3717, 545, 1457, 2359, 3249, 32, 900, 1758, 2606, 3445, 177, 996,
        1806, 2607, 3399, 87, 862, 1629, 2387, 3138, 3881, 520, 1249, 1969,
        2683, 3389, 4089, 686, 1372, 2052, 2726, 3393, 4054, 613, 1263, 1906,
        2544, 3176, 3803, 328, 944, 1555, 2160, 2761, 3356, 3947, 437, 1018,
        1594, 2166, 2733, 3296, 3855, 313, 863, 1409, 1951, 2489, 3022, 3552,
        4078, 504, 1023, 1537, 2048, 2556, 3060, 3560, 4057, 454, 944, 1431,
        1915, 2395, 2872, 3346, 3817, 189, 654, 1116, 1575, 2031, 2484, 2934,
        3381, 3826, 172, 611, 1048, 1482, 1913, 2342, 2769, 3192, 3614, 4033,
        353, 767, 1179, 1588, 1995, 2400, 2802, 3202, 3600, 3996, 294, 685,
        1075, 1462, 1847, 2231, 2612, 2991, 3368, 3743, 20, 392, 761, 1129,
        1494, 1858, 2220, 2580, 2939, 3295, 3650, 4003, 259, 608, 956, 1303,
        1647, 1990, 2332, 2672, 3010, 3346, 3681, 4015, 251, 581, 910, 1238,
        1564, 1888, 2211, 2533, 2853, 3172, 3489, 3805, 23, 337, 648, 959, 1268,
        1576, 1882, 2188, 2491, 2794, 3096, 3396, 3695, 3992, 193, 488, 782,
        1075, 1366, 1657, 1946, 2234, 2521, 2807, 3092, 3375, 3658, 3939, 123,
        402, 680, 958, 1233, 1508, 1782, 2055, 2327, 2598, 2867, 3136, 3404,
        3671, 3937
    ]
    channel_frequency_starts_exp = [
    ...
    unweights_exp = [
        2333, 488, 2660, 664, 2696, 568, 2476, 232, 2031, 3779, 1385, 3041, 559,
        2132, 3667, 1070, 2533, 3963, 1265, 2633, 3972, 1186, 2470, 3728, 865,
        2075, 3262, 330, 1474, 2597, 3700, 688, 1754, 2802, 3833, 751, 1749,
        2732, 3699, 556, 1494, 2419, 3330, 132, 1017, 1890, 2752, 3601, 343,
        1170, 1987, 2792, 3588, 278, 1054, 1820, 2578, 3326, 4065, 700, 1422,
        2137, 2843, 3541, 136, 819, 1494, 2163, 2825, 3479, 31, 672, 1307, 1935,
        2557, 3174, 3784, 292, 890, 1483, 2070, 2652, 3229, 3800, 270, 831,
        1387, 1938, 2484, 3026, 3563, 4095, 527, 1051, 1570, 2085, 2596, 3103,
        3605, 8, 503, 993, 1480, 1964, 2443, 2919, 3392, 3860, 230, 692, 1150,
        1605, 2057, 2506, 2952, 3394, 3833
    ]
    channel_frequency_starts_exp = [
        5, 6, 8, 10, 12, 15, 17, 20, 23, 26, 29, 32, 36, 40, 44, 48, 53, 58, 64,
        69, 75, 82, 89, 97, 104, 113
    ]
    channel_weight_starts_exp = [
    ...
    weights_exp = [
        1875, 3288, 702, 2300, 3983, 1647, 3481, 1288, 3255, 1187, 3273, 1317,
        3509, 1654, 3941, 2177, 455, 2869, 1225, 3714, 2142, 603, 3192, 1717,
        271, 2949, 1558, 194, 2951, 1637, 346, 3174, 1928, 702, 3594, 2409,
        1243, 96, 3063, 1951, 856, 3873, 2810, 1763, 731, 3809, 2805, 1815, 839,
        3971, 3021, 2082, 1156, 241, 3434, 2542, 1661, 791, 4027, 3177, 2337,
        1506, 685, 3970, 3167, 2373, 1588, 811, 43, 3378, 2626, 1881, 1144, 414,
        3788, 3073, 2365, 1663, 969, 281, 3696, 3021, 2352, 1689, 1033, 382,
        3833, 3194, 2560, 1932, 1310, 692, 80, 3570, 2968, 2371, 1779, 1192,
        609, 32, 3554, 2986, 2422, 1862, 1306, 755, 208, 3761, 3222, 2687, 2156,
        1629, 1106, 586, 70, 3654, 3146, 2641, 2139, 1641, 1147, 656, 168, 3779,
        3298, 2819, 2344, 1872, 1404, 938, 475, 15, 3654, 3200, 2749, 2300,
        1854, 1411, 971, 534, 99, 3762, 3332, 2905, 2480, 2058, 1638, 1221,
        806, 394, 4079, 3671, 3266, 2862, 2461, 2062, 1666, 1271, 879, 489,
        100, 3810, 3426, 3044, 2664, 2286, 1910, 1536, 1164, 794, 425, 59, 3790,
        3428, 3067, 2707, 2350, 1994, 1640, 1288, 938, 589, 242, 3992, 3649,
        3307, 2966, 2627, 2290, 1954, 1620, 1287, 956, 626, 298, 4067, 3742,
        3418, 3096, 2775, 2456, 2138, 1821, 1506, 1192, 880, 568, 259, 4046,
        3739, 3433, 3128, 2825, 2523, 2222, 1923, 1624, 1327, 1031, 737, 443,
        151, 3956, 3666, 3377, 3090, 2803, 2518, 2234, 1951, 1669, 1388, 1108,
        829, 552, 275, 0,
    ]
    unweights_exp = [
        2220, 807, 3393, 1795, 112, 2448, 614, 2807, 840, 2908, 822, 2778, 586,
        2441, 154, 1918, 3640, 1226, 2870, 381, 1953, 3492, 903, 2378, 3824,
        1146, 2537, 3901, 1144, 2458, 3749, 921, 2167, 3393, 501, 1686, 2852,
        3999, 1032, 2144, 3239, 222, 1285, 2332, 3364, 286, 1290, 2280, 3256,
        124, 1074, 2013, 2939, 3854, 661, 1553, 2434, 3304, 68, 918, 1758, 2589,
        3410, 125, 928, 1722, 2507, 3284, 4052, 717, 1469, 2214, 2951, 3681,
        307, 1022, 1730, 2432, 3126, 3814, 399, 1074, 1743, 2406, 3062, 3713,
        262, 901, 1535, 2163, 2785, 3403, 4015, 525, 1127, 1724, 2316, 2903,
        3486, 4063, 541, 1109, 1673, 2233, 2789, 3340, 3887, 334, 873, 1408,
        1939, 2466, 2989, 3509, 4025, 441, 949, 1454, 1956, 2454, 2948, 3439,
        3927, 316, 797, 1276, 1751, 2223, 2691, 3157, 3620, 4080, 441, 895,
        1346, 1795, 2241, 2684, 3124, 3561, 3996, 333, 763, 1190, 1615, 2037,
        2457, 2874, 3289, 3701, 16, 424, 829, 1233, 1634, 2033, 2429, 2824,
        3216, 3606, 3995, 285, 669, 1051, 1431, 1809, 2185, 2559, 2931, 3301,
        3670, 4036, 305, 667, 1028, 1388, 1745, 2101, 2455, 2807, 3157, 3506,
        3853, 103, 446, 788, 1129, 1468, 1805, 2141, 2475, 2808, 3139, 3469,
        3797, 28, 353, 677, 999, 1320, 1639, 1957, 2274, 2589, 2903, 3215,
        3527, 3836, 49, 356, 662, 967, 1270, 1572, 1873, 2172, 2471, 2768, 3064,
        3358, 3652, 3944, 139, 429, 718, 1005, 1292, 1577, 1861, 2144, 2426,
        2707, 2987, 3266, 3543, 3820, 4096,
    ]
    channel_frequency_starts_exp = [
    ...
    channel_weight_starts_exp = [
        0, 1, 3, 4, 6, 8, 10, 12, 14, 17, 19, 22, 25, 28, 31, 34, 38, 41, 45,
        49, 54, 58, 63, 69, 74, 80, 86, 93, 100, 107, 115, 123, 132, 141, 150,
        161, 172, 183, 195, 208, 222,
    ]
    channel_widths_exp = [
        1, 2, 1, 2, 2, 2, 2, 2, 3, 2, 3, 3, 3, 3, 3, 4, 3, 4, 4, 5, 4, 5, 6, 5,
        6, 6, 7, 7, 7, 8, 8, 9, 9, 9, 11, 11, 11, 12, 13, 14, 15,
    ]
    self.assertEqual(start_index, 4)
    self.assertEqual(end_index, 241)
  ...
  def testFilterBank(self):
    self.SingleFilterBankTest(
        'testdata/filter_bank_accumulation_8k.txt')
    self.SingleFilterBankTest(
        'testdata/filter_bank_accumulation_16k.txt')
    self.SingleFilterBankTest(
        'testdata/filter_bank_accumulation_44k.txt')
    self.SingleFilterBankVectorTest(
        'testdata/filter_bank_test1.txt')
