...
inline bool QuantizedProdExtraArgs(
  ...
  return QuantizedReduceProd<T> (input_data, input_zero_point, input_num_dims, output_data,
  output_zero_point, output_num_dims, axis, num_axis_dimensions, keep_dims, temp_index,
