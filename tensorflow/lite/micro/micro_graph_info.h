...
#ifndef TENSORFLOW_LITE_MICRO_MICRO_GRAPH_INFO_H_
#define TENSORFLOW_LITE_MICRO_MICRO_GRAPH_INFO_H_
...
class MicroGraphInfo {
 public:
  virtual ~MicroGraphInfo() = default;
...
#endif  // TENSORFLOW_LITE_MICRO_MICRO_GRAPH_INFO_H_
