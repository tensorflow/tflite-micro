...
class TestDataGenerator:
  ...
  def generate_makefile(self,
    ...
    makefile.write(
        ...
        test_file+ '  \\\n')
    makefile.write("$(TENSORFLOW_ROOT)tensorflow/lite/micro/python/interpreter/src/python_ops_resolver.cc \\\n")
    makefile.write('\n\n')
    makefile.write(src_prefix + '_HDR := \\\n')
    makefile.write("$(TENSORFLOW_ROOT)tensorflow/lite/micro/python/interpreter/src/python_ops_resolver.h \\\n")
    makefile.write('\n\n')
