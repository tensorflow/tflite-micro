...
if [[ ${2} == "hifi4" ]]; then
  ...
  LIBRARY_URL="https://github.com/foss-xtensa/tflmlib_vision/raw/main/archive/xi_tflmlib_vision_p6_22_05_17.zip"
  LIBRARY_DIRNAME="xi_tflmlib_vision_p6"
  LIBRARY_MD5="4a890d11a995289abd26a431817330ce"
else
