...
class HelloWorldQuantModelTest(test_util.TensorFlowTestCase):
  model_path = os.path.join(PREFIX_PATH, 'hello_world_no_quant.tflite')
  input_shape = (1, 1)
  output_shape = (1, 1)
  ...
  def test_input(self):
    ...
    input_scale, input_zero_point = evaluate.get_quantization_params(
        input_details)
  ...
  def test_output(self):
    ...
    output_scale, output_zero_point = evaluate.get_quantization_params(
        output_details)
