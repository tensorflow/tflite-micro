...
`bazel-bin/tensorflow/lite/micro/examples/hello_world/quantization:ptq  --save_dir=/tmp/model_created/`
"""
import math
import os
...
flags.DEFINE_string("save_dir", "/tmp/hello_world_quant_model",
