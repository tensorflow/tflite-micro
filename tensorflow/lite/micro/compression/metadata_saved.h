...
struct MetadataT : public ::flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<tflite::micro::compression::SubgraphT>>
      subgraphs{};
  MetadataT() = default;
...
struct Metadata FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<
      ::flatbuffers::Offset<tflite::micro::compression::Subgraph>>*
  subgraphs() const {
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVectorOfTables(subgraphs()) && verifier.EndTable();
  }
  MetadataT* UnPack(
...
inline ::flatbuffers::Offset<Metadata> CreateMetadata(
    ::flatbuffers::FlatBufferBuilder& _fbb, uint32_t schema_version = 1,
    ::flatbuffers::Offset<::flatbuffers::Vector<
        ::flatbuffers::Offset<tflite::micro::compression::Subgraph>>>
        subgraphs = 0) {
...
inline ::flatbuffers::Offset<Metadata> CreateMetadataDirect(
    ...
    const std::vector<::flatbuffers::Offset<
        tflite::micro::compression::Subgraph>>* subgraphs = nullptr) {
  auto subgraphs__ =
      subgraphs
          ? _fbb.CreateVector<
                ::flatbuffers::Offset<tflite::micro::compression::Subgraph>>(
                *subgraphs)
          : 0;
  return tflite::micro::compression::CreateMetadata(_fbb, schema_version,
                                                    subgraphs__);
}
...
struct SubgraphT : public ::flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<tflite::micro::compression::LutTensorT>>
      lut_tensors{};
  SubgraphT() = default;
...
struct Subgraph FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<
      ::flatbuffers::Offset<tflite::micro::compression::LutTensor>>*
  lut_tensors() const {
    return GetPointer<const ::flatbuffers::Vector<
        ::flatbuffers::Offset<tflite::micro::compression::LutTensor>>*>(
        VT_LUT_TENSORS);
  ...
  bool Verify(::flatbuffers::Verifier& verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVectorOfTables(lut_tensors()) && verifier.EndTable();
  }
  SubgraphT* UnPack(
      const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
  void UnPackTo(
...
inline ::flatbuffers::Offset<Subgraph> CreateSubgraphDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    const std::vector<::flatbuffers::Offset<
        tflite::micro::compression::LutTensor>>* lut_tensors = nullptr) {
  auto lut_tensors__ =
      lut_tensors
          ? _fbb.CreateVector<
                ::flatbuffers::Offset<tflite::micro::compression::LutTensor>>(
                *lut_tensors)
          : 0;
  return tflite::micro::compression::CreateSubgraph(_fbb, lut_tensors__);
}
...
struct LutTensor FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  int32_t tensor() const { return GetField<int32_t>(VT_TENSOR, 0); }
  ...
  void UnPackTo(
      LutTensorT* _o,
      const ::flatbuffers::resolver_function_t* _resolver = nullptr) const;
  static ::flatbuffers::Offset<LutTensor> Pack(
      ::flatbuffers::FlatBufferBuilder& _fbb, const LutTensorT* _o,
      const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
};
...
inline ::flatbuffers::Offset<LutTensor> CreateLutTensor(
    ::flatbuffers::FlatBufferBuilder& _fbb, int32_t tensor = 0,
    uint32_t value_buffer = 0, uint8_t index_bitwidth = 0) {
...
::flatbuffers::Offset<LutTensor> CreateLutTensor(
    ::flatbuffers::FlatBufferBuilder& _fbb, const LutTensorT* _o,
    const ::flatbuffers::rehasher_function_t* _rehasher = nullptr);
...
inline MetadataT::MetadataT(const MetadataT& o)
  ...
  for (const auto& subgraphs_ : o.subgraphs) {
    subgraphs.emplace_back(
        (subgraphs_) ? new tflite::micro::compression::SubgraphT(*subgraphs_)
                     : nullptr);
  }
}
...
inline void Metadata::UnPackTo(
  ...
  (void)_resolver;
  {
    auto _e = schema_version();
    _o->schema_version = _e;
  }
  {
    auto _e = subgraphs();
    if (_e) {
      ...
      for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->subgraphs[_i]) {
          ...
          _o->subgraphs[_i] =
              std::unique_ptr<tflite::micro::compression::SubgraphT>(
  ...
  auto _subgraphs =
      _o->subgraphs.size()
          ? _fbb.CreateVector<
                ...
                &_va)
          : 0;
  return tflite::micro::compression::CreateMetadata(_fbb, _schema_version,
                                                    _subgraphs);
}

inline SubgraphT::SubgraphT(const SubgraphT& o) {
  lut_tensors.reserve(o.lut_tensors.size());
  for (const auto& lut_tensors_ : o.lut_tensors) {
    lut_tensors.emplace_back(
        (lut_tensors_)
            ? new tflite::micro::compression::LutTensorT(*lut_tensors_)
            : nullptr);
  }
}
...
inline void Subgraph::UnPackTo(
  ...
  (void)_resolver;
  {
    auto _e = lut_tensors();
    if (_e) {
      _o->lut_tensors.resize(_e->size());
      for (::flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        if (_o->lut_tensors[_i]) {
          _e->Get(_i)->UnPackTo(_o->lut_tensors[_i].get(), _resolver);
        } else {
          _o->lut_tensors[_i] =
              std::unique_ptr<tflite::micro::compression::LutTensorT>(
                  _e->Get(_i)->UnPack(_resolver));
        };
      }
    } else {
      _o->lut_tensors.resize(0);
    }
  }
}
  ...
  auto _lut_tensors =
      _o->lut_tensors.size()
          ? _fbb.CreateVector<
                ...
                _o->lut_tensors.size(),
                [](size_t i, _VectorArgs* __va) {
                  return CreateLutTensor(*__va->__fbb,
                                         __va->__o->lut_tensors[i].get(),
                                         __va->__rehasher);
                },
                &_va)
          : 0;
  return tflite::micro::compression::CreateSubgraph(_fbb, _lut_tensors);
}

inline LutTensorT* LutTensor::UnPack(
    const ::flatbuffers::resolver_function_t* _resolver) const {
...
inline void LutTensor::UnPackTo(
    LutTensorT* _o, const ::flatbuffers::resolver_function_t* _resolver) const {
  (void)_o;
  (void)_resolver;
  {
    auto _e = tensor();
  ...
  {
    auto _e = value_buffer();
    _o->value_buffer = _e;
  }
  {
    auto _e = index_bitwidth();
    _o->index_bitwidth = _e;
  }
}

inline ::flatbuffers::Offset<LutTensor> LutTensor::Pack(
    ::flatbuffers::FlatBufferBuilder& _fbb, const LutTensorT* _o,
    const ::flatbuffers::rehasher_function_t* _rehasher) {
...
inline ::flatbuffers::Offset<LutTensor> CreateLutTensor(
  ...
  return tflite::micro::compression::CreateLutTensor(
      _fbb, _tensor, _value_buffer, _index_bitwidth);
}

inline const tflite::micro::compression::Metadata* GetMetadata(
    const void* buf) {
  return ::flatbuffers::GetRoot<tflite::micro::compression::Metadata>(buf);
}

inline const tflite::micro::compression::Metadata* GetSizePrefixedMetadata(
    const void* buf) {
  return ::flatbuffers::GetSizePrefixedRoot<
      tflite::micro::compression::Metadata>(buf);
}
...
inline bool VerifySizePrefixedMetadataBuffer(
  ...
  return verifier
      .VerifySizePrefixedBuffer<tflite::micro::compression::Metadata>(nullptr);
}
...
inline std::unique_ptr<tflite::micro::compression::MetadataT> UnPackMetadata(
  ...
  return std::unique_ptr<tflite::micro::compression::MetadataT>(
      GetMetadata(buf)->UnPack(res));
}

inline std::unique_ptr<tflite::micro::compression::MetadataT>
UnPackSizePrefixedMetadata(
    const void* buf, const ::flatbuffers::resolver_function_t* res = nullptr) {
  return std::unique_ptr<tflite::micro::compression::MetadataT>(
