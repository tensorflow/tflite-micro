...
class MicroAllocator {
 ...
 private:
  ...
  TfLiteBridgeBuiltinDataAllocator* builtin_data_allocator_ = nullptr; // Initialized as nullptr to prevent any possible issues related to accessing uninitialized memory.
