...
void* BatchMatMulInit(TfLiteContext* context, const char* buffer, size_t length) {
...
TFLMRegistration Register_BATCH_MATMUL() {
  return tflite::micro::RegisterOp(BatchMatMulInit, BatchMatMulPrepare, BatchMatMulEval);
}
