...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
...
inline void AffineQuantize(const tflite::micro::QuantizationParams& op_params,
...
inline void PerChannelQuantize(
    const tflite::micro::PerChannelQuantizationParams& op_params,
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_QUANTIZE_H_
