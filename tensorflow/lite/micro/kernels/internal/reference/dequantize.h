...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
...
inline void Dequantize(const tflite::micro::DequantizationParams& op_params,
...
inline void PerChannelDequantize(
    const tflite::micro::PerChannelDequantizationParams& op_params,
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_DEQUANTIZE_H_
