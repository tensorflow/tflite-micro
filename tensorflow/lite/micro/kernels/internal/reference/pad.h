...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_PAD_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_PAD_H_
...
inline void PadImpl(const tflite::micro::PadParams& op_params,
...
template <typename T, typename P>
inline void Pad(const tflite::micro::PadParams& op_params,
                const RuntimeShape& input_shape, const T* input_data,
                const P* pad_value_ptr, const RuntimeShape& output_shape,
                T* output_data) {
...
template <typename T, typename P>
inline void PadImageStyle(const tflite::micro::PadParams& op_params,
                          const RuntimeShape& input_shape, const T* input_data,
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_PAD_H_
