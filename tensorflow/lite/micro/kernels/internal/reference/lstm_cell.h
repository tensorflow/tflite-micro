...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
...
#include "tensorflow/lite/micro/kernels/internal/reference/concatenation.h"
...
inline void LstmCell(
  ...
  const RuntimeShape* concat_input_arrays_shapes[2] = {&input_shape,
                                                       &prev_activ_shape};
  tflite::micro::ConcatenationParams concat_params;
  ...
  // Fully connected
  tflite::micro::FullyConnectedParams fc_params;
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_LSTM_CELL_H_
