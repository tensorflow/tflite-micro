...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
...
template <typename T>
inline void ResizeBilinear(const tflite::micro::ResizeBilinearParams& op_params,
...
inline void ResizeBilinearInteger(
    const tflite::micro::ResizeBilinearParams& op_params,
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_RESIZE_BILINEAR_H_
