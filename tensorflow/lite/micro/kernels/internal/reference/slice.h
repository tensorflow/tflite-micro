...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_SLICE_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_SLICE_H_
...
template <typename T>
inline void Slice(const tflite::micro::SliceParams& op_params,
                  const RuntimeShape& input_shape,
                  const RuntimeShape& output_shape,
                  SequentialTensorWriter<T>* writer) {
...
inline void SliceInt4(const tflite::micro::SliceParams& op_params,
                      const RuntimeShape& input_shape,
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_REFERENCE_SLICE_H_
