...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_STRIDED_SLICE_LOGIC_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_STRIDED_SLICE_LOGIC_H_
...
inline int StridedSliceStartForAxis(const StridedSliceParams& params,
...
inline int StridedSliceEndForAxis(const StridedSliceParams& params,
...
inline StridedSliceParams BuildStridedSliceParams(
