...
==============================================================================*/
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_QUANTIZATION_UTIL_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_QUANTIZATION_UTIL_H_
...
using micro::DoubleFromFractionAndShift;
using micro::FakeQuantizeArray;
using micro::IntegerDoubleCompare;
using micro::IntegerDoubleMultiply;
using micro::IntegerFrExp;
using micro::NudgeQuantizationRange;
using micro::PreprocessLogSoftmaxScalingExp;
using micro::PreprocessSoftmaxScaling;
using micro::QuantizeMultiplier;
using micro::QuantizeMultiplierArray;
using micro::QuantizeMultiplierGreaterThanOne;
using micro::QuantizeMultiplierSmallerThanOneExp;
using micro::SafeCast;
#endif  // TENSORFLOW_LITE_KERNELS_INTERNAL_QUANTIZATION_UTIL_H_

}  // namespace tflite

#endif  // TENSORFLOW_LITE_MICRO_KERNELS_INTERNAL_QUANTIZATION_UTIL_H_
