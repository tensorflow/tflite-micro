...
#include "tensorflow/lite/micro/kernels/internal/reference/maximum_minimum.h"
...
using micro::kInputTensor1;
using micro::kInputTensor2;
using micro::kOutputTensor;

using micro::MaximumOp;
using micro::MinimumOp;
using micro::OpContext;
using micro::Register_MAXIMUM;
using micro::Register_MAXIMUM_INT8;
using micro::Register_MINIMUM;
using micro::Register_MINIMUM_INT8;
}  // namespace tflite
