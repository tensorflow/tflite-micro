...
TfLiteStatus SpaceToBatchNDEval(TfLiteContext* context, TfLiteNode* node) {
  ...
  const TfLiteEvalTensor* input =
      tflite::micro::GetEvalInput(context, node, kSpaceToBatchNDInputTensor);
  const TfLiteEvalTensor* block_shape =
      tflite::micro::GetEvalInput(context, node, kSpaceToBatchNDBlockShapeTensor);
  const TfLiteEvalTensor* crops =
      tflite::micro::GetEvalInput(context, node, kSpaceToBatchNDCropsTensor);
  TfLiteEvalTensor* output =
      tflite::micro::GetEvalOutput(context, node, kSpaceToBatchNDOutputTensor);
...
TfLiteRegistration Register_SPACE_TO_BATCH_ND() {
  return {/*init=*/Init,
          /*free=*/nullptr,
          /*prepare=*/SpaceToBatchNDPrepare,
          /*invoke=*/SpaceToBatchNDEval,
