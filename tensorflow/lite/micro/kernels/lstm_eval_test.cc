...
TF_LITE_MICRO_TEST(CheckGateOutputFloat) {
  ...
  auto float_node_contents = tflite::testing::Create2x3x2X2FloatNodeContents(
...
//   auto float_node_contents =
//   tflite::testing::Create2x3x2X2FloatNodeContents(
//       gate_output_data.input_data, gate_output_data.hidden_state,
//       gate_output_data.cell_state);
//   auto int8_model_contents = tflite::testing::CreateInt8ModelContents(
//       quantization_settings, float_node_contents);
...
//       int8_model_contents.ForgetGateData(), quantization_settings,
...
//       int8_model_contents.GetInputData(),
//       int8_model_contents.GetHiddenStateData(),
//       int8_model_contents.InputGateData(), quantization_settings,
...
//       int8_model_contents.GetInputData(),
//       int8_model_contents.GetHiddenStateData(),
//       int8_model_contents.OutputGateData(), quantization_settings,
...
//       int8_model_contents.GetInputData(),
//       int8_model_contents.GetHiddenStateData(),
//       int8_model_contents.CellGateData(), quantization_settings,
...
//       gate_output_data, tflite::testing::kModelSettings.cell_clip,
//       tflite::testing::kTestFloatTolerance);
// }
...
//   auto float_node_contents =
//   tflite::testing::Create2x3x2X2FloatNodeContents(); auto int8_model_contents
//   = tflite::testing::CreateInt8ModelContents(
//       quantization_settings, float_node_contents);
//   auto evaluation_params = tflite::testing::CreateIntegerParameter(
//       tflite::testing::kModelSettings, quantization_settings,
//       int8_model_contents);
...
//   tflite::testing::TestCellUpdateQuantized<int8_t, int32_t, int16_t, 2, 2,
//   2>(
//       gate_output_data, quantization_settings, evaluation_params.cell_scale,
...
//   2,
//                                                   2, 2>(
//       gate_output_data, quantization_settings, evaluation_params, tolerance);
// }
...
//       tflite::testing::kModelSettings, float_node_contents,
//       gate_output_data, tflite::testing::kTestFloatTolerance);
// }
...
//   tflite::testing::TestOneStepLSTMQuantized<int8_t, int32_t, int16_t, 2, 3,
//   2,
//                                             2>(
...
//                                      float_node_contents, kernel_eval_data,
//                                      tflite::testing::kTestFloatTolerance);
// }
...
//       quantization_settings, evaluation_params, kernel_eval_data,
