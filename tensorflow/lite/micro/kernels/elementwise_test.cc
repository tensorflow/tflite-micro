...
TF_LITE_MICRO_TEST(AbsInt8) {
  ...
  float input_data[] = {15., 46., 78., -142., -1., -17., -49., 113.};
  int8_t input_quantized[8];

  float expected_output_data[] = {15., 46., 78., 142., 1., 17., 49., 113.};
  ...
  tflite::testing::TestElementwiseQuantized(
      ...
      input_scale, input_zero_point, shape, expected_output_data,
...
TF_LITE_MICRO_TEST(AbsInt8SameScale) {
  ...
  tflite::testing::TestElementwiseQuantized(
      tflite::ops::micro::Register_ABS(), shape, input_data, input_quantized,
      scale, zero_point, shape, expected_output_data, output_quantized, scale,
      -128);
}
...
TF_LITE_MICRO_TEST(AbsInt16) {
  ...
  tflite::testing::TestElementwiseQuantized(
      tflite::ops::micro::Register_ABS(), shape, input_data, input_quantized,
      input_scale, /*input_zero_point*/ 0, shape, expected_output_data,
