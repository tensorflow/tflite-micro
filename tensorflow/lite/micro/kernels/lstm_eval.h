...
namespace lstm_internal = micro::lstm_internal;
using micro::CreateGateParams;
using micro::CreateGateParamsFloat;
using micro::CreateInterGateMulParams;
using micro::CreateInterGateMulParamsFloat;
using micro::EvalLstm;
