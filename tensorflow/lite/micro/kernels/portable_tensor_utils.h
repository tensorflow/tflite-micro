...
#ifndef TENSORFLOW_LITE_MICRO_KERNELS_PORTABLE_TENSOR_UTILS_H_
#define TENSORFLOW_LITE_MICRO_KERNELS_PORTABLE_TENSOR_UTILS_H_
...
#endif  // TENSORFLOW_LITE_MICRO_KERNELS_PORTABLE_TENSOR_UTILS_H_
