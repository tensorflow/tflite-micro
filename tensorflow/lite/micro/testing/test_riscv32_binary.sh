...
# ==============================================================================
#
# Tests a RISCV32 binary with QEMU by parsing the log output.
#
...
declare -r TEST_TMPDIR=/tmp/test_riscv32_binary/
declare -r MICRO_LOG_PATH=${TEST_TMPDIR}/$1
declare -r MICRO_LOG_FILENAME=${MICRO_LOG_PATH}/logs.txt
mkdir -p ${MICRO_LOG_PATH}

qemu-riscv32-static -cpu rv32 $1 2>&1 | tee ${MICRO_LOG_FILENAME}
