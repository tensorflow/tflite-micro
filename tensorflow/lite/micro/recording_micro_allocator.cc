...
RecordedAllocation RecordingMicroAllocator::GetRecordedAllocation(
  ...
  switch (allocation_type) {
    ...
    // the function MicroPrintf was never reached outside the switch, because each case has a return.
    // As the intention of the MicroPrintf is to be called when no matching case is found,
    // a default case was added to contemplate an invalid allocation type
    default:
