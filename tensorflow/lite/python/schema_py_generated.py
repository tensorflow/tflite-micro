...
def OperatorAddCustomOptionsOffset(builder, customOptionsOffset): builder.PrependUint64Slot(9, customOptionsOffset, 0)
def AddCustomOptionsOffset(builder, customOptionsOffset):
    return OperatorAddCustomOptionsOffset(builder, customOptionsOffset)
def OperatorAddCustomOptionsSize(builder, customOptionsSize): builder.PrependUint64Slot(10, customOptionsSize, 0)
def AddCustomOptionsSize(builder, customOptionsSize):
    return OperatorAddCustomOptionsSize(builder, customOptionsSize)
...
class OperatorT(object):
    ...
    def __init__(self):
        ...
        self.customOptionsOffset = 0  # type: int
        self.customOptionsSize = 0  # type: int
    ...
    def _UnPack(self, operator):
        ...
        self.customOptionsOffset = operator.CustomOptionsOffset()
        self.customOptionsSize = operator.CustomOptionsSize()
    ...
    def Pack(self, builder):
        ...
        OperatorAddCustomOptionsOffset(builder, self.customOptionsOffset)
        OperatorAddCustomOptionsSize(builder, self.customOptionsSize)
